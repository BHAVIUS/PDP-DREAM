...
public class NwaHomeDebugDemo : TkgnPageController
{
  private const string rzrClass = nameof(NwaHomeDebugDemo);
  public NwaHomeDebugDemo(ILoggerFactory lgrFtry,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel("/NwaHome/DebugDemo", PdpSitePathKey);
    PSRM.InitRazorPageMenus("_NwaHomeSpanPageMenu", "_NexusWebLibDebugPageMenu");
    ResetCoreRepository();
