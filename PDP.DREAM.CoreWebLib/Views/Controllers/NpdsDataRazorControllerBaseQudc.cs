...
public abstract partial class QebiDataRazorViewControllerBase : WraceRazorViewControllerBase, IQebiUser
{
  // prefix rzr from RaZoR view
  private const string rzrClass = nameof(QebiDataRazorViewControllerBase);
...
#endif
      usrSsnIdentified = QUDC.CheckSessionQebiUser(ref wrace);
#if DEBUG
  ...
  public async Task<QebIdentityResult> QebUserSigninAsync(string? userName, string? passWord)
  {
    ...
    // var passWordOk = QebCryptoService.VerifyHashedToken(qebUser.PasswordHash, passWord);
