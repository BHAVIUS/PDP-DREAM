...
// TODO: reconcile with PDP.DREAM.CoreDataLib.Models.ICiaamClient
public partial interface IQebiUser
{
  protected static ChangeUsernameUxm ArgCheckModel(ChangeUsernameUxm uxm)
  {
  ...
  protected static ChangeUsernameUxm NotifyUsernameWithToken(ChangeUsernameUxm uxm, HttpContext cntxt)
  {
    try
    {
