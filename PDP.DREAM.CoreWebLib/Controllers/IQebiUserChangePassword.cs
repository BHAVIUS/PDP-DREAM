...
public partial interface IQebiUser
{
  protected static ChangePasswordUxm ChangePasswordWithToken(string username, string securitytoken, string newpassword)
  {
    ...
    uxm = ChangePasswordWithToken(uxm, new QebiDalContext());
    return uxm;
  }

  protected static ChangePasswordUxm ChangePasswordWithToken(ChangePasswordUxm uxm, QebiDalContext qudc)
  {
    try
    {
  ...
  protected static ChangePasswordUxm ChangePasswordWithOld(ChangePasswordUxm uxm, QebiDalContext qudc)
  {
  ...
  protected static ChangePasswordUxm StorePassword(ChangePasswordUxm uxm, QebiUser usr, QebiDalContext qudc)
  {
