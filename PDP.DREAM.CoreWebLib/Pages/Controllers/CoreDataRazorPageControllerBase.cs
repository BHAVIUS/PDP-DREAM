...
// TODO: move as many methods as possible to static in ISiaaUser 
//  for shared use by CoreDataRazor*ControllerBase where * is Page or View

// convention: name abstract controllers with suffix ControllerBase
public abstract class CoreDataRazorPageControllerBase : PageModel, ISiaaUser
{
  private const string rzrCntrllr = nameof(CoreDataRazorPageControllerBase);
  ...
  //public const string CdlRanpPage = "CoreDataLibPage"; // by Razor page CoreDataLib
  //public const string CrlRanpPage = "CoreRestLibPage"; //  by Razor page for CoreRestLib
  //public const string CwlRanpPage = "CoreWebLibPage"; // by Razor page for CoreWebLib
  ...
  {
    qebLogger = InitLogger<CoreDataRazorPageControllerBase>();
  ...
  public CoreDataRazorPageControllerBase(QebIdentityContext userCntxt)
  {
    qebLogger = InitLogger<CoreDataRazorPageControllerBase>();
    qebUserRestCntxt = InitRestContext();
  ...
  public CoreDataRazorPageControllerBase(CoreDbsqlContext npdsCntxt)
  {
    qebLogger = InitLogger<CoreDataRazorPageControllerBase>();
    qebUserRestCntxt = InitRestContext();
    qebUserDataCntxt = new QebIdentityContext(NPDSSD.NpdsUserDbconstr);
  ...
  public CoreDataRazorPageControllerBase(QebIdentityContext userCntxt, CoreDbsqlContext npdsCntxt)
  {
    qebLogger = InitLogger<CoreDataRazorPageControllerBase>();
    qebUserRestCntxt = InitRestContext();
    qebUserDataCntxt = userCntxt;
  ...
  {
#if DEBUG
    CatchNullQurc(nameof(OnPageHandlerExecuting), rzrCntrllr);
#endif
    ResetCoreRepository();
    ViewData[PsrKey] = PSR;
  }
  public override void OnPageHandlerExecuted(PageHandlerExecutedContext exeCntxt)
  {
    ...
    if (exeCntxt.Result is PageResult)
    {
      var result = (PageResult)exeCntxt.Result;
