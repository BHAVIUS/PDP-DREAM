...
public class AnonModeIndex : CoreDataRazorPageControllerBase
{
  private const string rzrCntrllr = nameof(AnonModeIndex);
  public AnonModeIndex(QebIdentityContext? userCntxt = null, CoreDbsqlContext? npdsCntxt = null,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSR = new PdpSiteRazorModel(DepAnonModeIndex,
      $"{PDPSS.AppOwnerShortName}: Anonymous Mode");
