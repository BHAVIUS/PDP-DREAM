...
public class AnonModeResetPassword : CoreDataRazorPageControllerBase
{
  private const string rzrClass = nameof(AnonModeResetPassword);
  public AnonModeResetPassword(ILoggerFactory lgrFtry,
