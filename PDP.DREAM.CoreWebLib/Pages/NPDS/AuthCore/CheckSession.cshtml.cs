...
public class AuthCoreCheckSession : CoreDataRazorPageControllerBase
{
  private const string rzrCntrllr = nameof(AuthCoreCheckSession);
  public AuthCoreCheckSession(QebIdentityContext? userCntxt = null, CoreDbsqlContext? npdsCntxt = null,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSR = new PdpSiteRazorModel(DepAuthCoreCheckSession,
      $"{PDPSS.AppOwnerShortName}: Check Session");
