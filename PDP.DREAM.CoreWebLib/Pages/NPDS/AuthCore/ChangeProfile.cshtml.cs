...
public class AuthCoreChangeProfile : CoreDataRazorPageControllerBase
{
  private const string rzrCntrllr = nameof(AuthCoreChangeProfile);
  public AuthCoreChangeProfile(QebIdentityContext? userCntxt = null, CoreDbsqlContext? npdsCntxt = null,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSR = new PdpSiteRazorModel(DepAuthCoreChangeProfile,
