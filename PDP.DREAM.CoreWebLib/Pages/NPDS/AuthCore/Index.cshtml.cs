...
public class AuthCoreIndex : CoreDataRazorPageControllerBase
{
  private const string rzrCntrllr = nameof(AuthCoreIndex);
  public AuthCoreIndex(QebIdentityContext? userCntxt = null, CoreDbsqlContext? npdsCntxt = null,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSR = new PdpSiteRazorModel(DepAuthCoreIndex,
       $"{PDPSS.AppOwnerShortName}: Authorized User");
