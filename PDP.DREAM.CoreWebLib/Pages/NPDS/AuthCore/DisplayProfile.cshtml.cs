...
public class AuthCoreDisplayProfile : CoreDataRazorPageControllerBase
{
  private const string rzrCntrllr = nameof(AuthCoreDisplayProfile);
  public AuthCoreDisplayProfile(QebIdentityContext? userCntxt = null, CoreDbsqlContext? npdsCntxt = null,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSR = new PdpSiteRazorModel(DepAuthCoreDisplayProfile,
