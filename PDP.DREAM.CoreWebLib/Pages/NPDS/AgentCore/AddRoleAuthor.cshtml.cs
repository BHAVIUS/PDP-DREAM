...
public class AgentCoreAddRoleAuthor : CoreDataRazorPageControllerBase
{
  private const string rzrCntrllr = nameof(AgentCoreAddRoleAuthor);
  public AgentCoreAddRoleAuthor(QebIdentityContext? userCntxt = null, CoreDbsqlContext? npdsCntxt = null,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSR = new PdpSiteRazorModel(DepAgentCoreAddRoleAuthor,
   $"{PDPSS.AppOwnerShortName}: Add NPDS Author Role");
    PSR.InitRazorPageMenus("_AgentCoreSpanPageMenu");
    ResetCoreRepository();
