...
public class AgentCoreAddRoleEditor : CoreDataRazorPageControllerBase
{
  private const string rzrCntrllr = nameof(AgentCoreAddRoleEditor);
  public AgentCoreAddRoleEditor(QebIdentityContext? userCntxt = null, CoreDbsqlContext? npdsCntxt = null,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSR = new PdpSiteRazorModel(DepAgentCoreAddRoleEditor,
