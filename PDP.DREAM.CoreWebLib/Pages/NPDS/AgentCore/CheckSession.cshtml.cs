...
public class AgentCoreCheckSession : CoreDataRazorPageControllerBase
{
  private const string rzrCntrllr = nameof(AgentCoreCheckSession);
  public AgentCoreCheckSession(QebIdentityContext? userCntxt = null, CoreDbsqlContext? npdsCntxt = null,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSR = new PdpSiteRazorModel(DepAgentCoreCheckSession,
      $"{PDPSS.AppOwnerShortName}: Check Agent");
