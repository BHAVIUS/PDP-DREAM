...
public class AgentCoreIndex : CoreDataRazorPageControllerBase
{
  private const string rzrCntrllr = nameof(AgentCoreIndex);
  public AgentCoreIndex(QebIdentityContext? userCntxt = null, CoreDbsqlContext? npdsCntxt = null,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSR = new PdpSiteRazorModel(DepAgentCoreIndex,
       $"{PDPSS.AppOwnerShortName}: Authorized Agent");
