...
public class AgentCoreAddRoleAdmin : CoreDataRazorPageControllerBase
{
  private const string rzrCntrllr = nameof(AgentCoreAddRoleAdmin);
  public AgentCoreAddRoleAdmin(QebIdentityContext? userCntxt = null, CoreDbsqlContext? npdsCntxt = null,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSR = new PdpSiteRazorModel(DepAgentCoreAddRoleAdmin,
