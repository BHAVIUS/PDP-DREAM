...
public class EditorModeHelp : QebiDataRazorPageControllerBase
{
  private const string rzrClass = nameof(EditorModeHelp);
  public EditorModeHelp() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepEditorModeHelp, $"{PDPSS.AppOwnerNameShort}: Editor Help");
