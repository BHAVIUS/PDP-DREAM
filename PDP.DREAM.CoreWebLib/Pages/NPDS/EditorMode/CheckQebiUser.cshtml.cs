...
public class EditorModeCheckQebiUser : QebiDataRazorPageControllerBase
{
  private const string rzrClass = nameof(EditorModeCheckQebiUser);
  public EditorModeCheckQebiUser() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepEditorModeCheckQebiUser, $"{PDPSS.AppOwnerNameShort}: Check QEBI User");
