...
{
  private const string rzrCntrllr = nameof(AuthModeChangePassword);
  public AuthModeChangePassword(QebIdentityContext? userCntxt = null, CoreDbsqlContext? npdsCntxt = null,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSR = new PdpSiteRazorModel(DepAuthModeChangePassword,
