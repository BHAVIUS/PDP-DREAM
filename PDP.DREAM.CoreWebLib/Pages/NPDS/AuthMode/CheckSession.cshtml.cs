...
public class AuthModeCheckSession : CoreDataRazorPageControllerBase
{
  private const string rzrClass = nameof(AuthModeCheckSession);
  public AuthModeCheckSession(ILoggerFactory lgrFtry,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepAuthModeCheckSession,
