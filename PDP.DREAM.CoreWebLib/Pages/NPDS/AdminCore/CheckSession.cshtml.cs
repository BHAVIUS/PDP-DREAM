...
public class AdminCoreCheckSession : CoreDataRazorPageControllerBase
{
  private const string rzrCntrllr = nameof(AdminCoreCheckSession);
  public AdminCoreCheckSession(QebIdentityContext? userCntxt = null, CoreDbsqlContext? npdsCntxt = null,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSR = new PdpSiteRazorModel("/NPDS/AdminCore/CheckSession", $"{PDPSS.AppOwnerShortName}: Check Admin");
