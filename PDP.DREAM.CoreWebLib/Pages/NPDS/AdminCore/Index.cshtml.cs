...
public class AdminCoreIndex : CoreDataRazorPageControllerBase
{
  private const string rzrCntrllr = nameof(AdminCoreIndex);
  public AdminCoreIndex(QebIdentityContext? userCntxt = null, CoreDbsqlContext? npdsCntxt = null,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSR = new PdpSiteRazorModel("/NPDS/AdminCore/Index",
       $"{PDPSS.AppOwnerShortName}: Authorized Administrator"); 
