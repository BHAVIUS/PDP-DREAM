...
public class DebugModeRazorRoutes : CoreDataRazorPageControllerBase
{
  private const string rzrClass = nameof(DebugModeRazorRoutes);
  public DebugModeRazorRoutes() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepDebugModeRazorRoutes, "PDP-DREAM RazorRoutes", true);
