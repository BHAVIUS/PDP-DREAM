...
public class CwlHomeDevTest : TkgcPageController
{
  private const string rzrClass = nameof(CwlHomeDevTest);
  public CwlHomeDevTest() : base() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepCwlHomeDevTest, PdpSitePathKey);
    PSRM.InitRazorPageMenus("_CoreWebLibSpanPageMenu", "_CoreWebLibDebugPageMenu");
    ...
    ResetCoreRepository(); // for DevTest
