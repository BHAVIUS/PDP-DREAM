...
public class CwlHomeQurcProperties : CoreDataRazorPageControllerBase
{
  private const string rzrCntrllr = nameof(CwlHomeQurcProperties);
  public CwlHomeQurcProperties(QebIdentityContext? userCntxt = null, CoreDbsqlContext? npdsCntxt = null)
