...
public class AgentModeCheckNpdsAgent : TkgcPageController
{
  private const string rzrClass = nameof(AgentModeCheckNpdsAgent);
  public AgentModeCheckNpdsAgent() : base() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepAgentModeCheckNpdsAgent, $"{PDPSS.AppOwnerNameShort}: Check NPDS Agent");
