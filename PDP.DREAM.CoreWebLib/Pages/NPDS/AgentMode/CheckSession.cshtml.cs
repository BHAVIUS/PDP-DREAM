...
public class AgentModeCheckSession : CoreDataRazorPageControllerBase
{
  private const string rzrCntrllr = nameof(AgentModeCheckSession);
  public AgentModeCheckSession(QebIdentityContext? userCntxt = null, CoreDbsqlContext? npdsCntxt = null,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSR = new PdpSiteRazorModel(DepAgentModeCheckSession,
