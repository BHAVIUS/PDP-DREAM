...
public class AgentModeAddRoleAuthor : TkgcPageController
{
  private const string rzrClass = nameof(AgentModeAddRoleAuthor);
  public AgentModeAddRoleAuthor(ILoggerFactory lgrFtry,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepAgentModeAddRoleAuthor, $"{PDPSS.AppOwnerShortName}: Add NPDS Author Role");
  ...
  public IActionResult OnPost()
  {
    ...
    var strAgent = NamesForClientRoles.NpdsAuthor.ToString();
    Guid? roleGuid = null;
