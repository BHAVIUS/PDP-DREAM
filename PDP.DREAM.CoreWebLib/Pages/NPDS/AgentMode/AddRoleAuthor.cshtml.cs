...
public class AgentModeAddRoleAuthor : QebiDataRazorPageControllerBase
{
  private const string rzrClass = nameof(AgentModeAddRoleAuthor);
  public AgentModeAddRoleAuthor() : base() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepAgentModeAddRoleAuthor, $"{PDPSS.AppOwnerNameShort}: Add NPDS Author Role");
