...
public class AgentModeAddRoleAgent : CoreDataRazorPageControllerBase
{
  private const string rzrCntrllr = nameof(AgentModeAddRoleAgent);
  public AgentModeAddRoleAgent(QebIdentityContext? userCntxt = null, CoreDbsqlContext? npdsCntxt = null,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSR = new PdpSiteRazorModel(DepAgentModeAddRoleAgent,
