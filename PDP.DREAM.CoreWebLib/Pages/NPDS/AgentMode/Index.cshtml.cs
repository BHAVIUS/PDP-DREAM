...
public class AgentModeIndex : CoreDataRazorPageControllerBase
{
  private const string rzrCntrllr = nameof(AgentModeIndex);
  public AgentModeIndex(QebIdentityContext? userCntxt = null, CoreDbsqlContext? npdsCntxt = null,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSR = new PdpSiteRazorModel(DepAgentModeIndex,
       $"{PDPSS.AppOwnerShortName}: Agent Mode");
