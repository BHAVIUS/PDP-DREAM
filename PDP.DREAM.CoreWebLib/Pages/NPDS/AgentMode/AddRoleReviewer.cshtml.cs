...
public class AgentModeAddRoleReviewer : QebiDataRazorPageControllerBase
{
  private const string rzrClass = nameof(AgentModeAddRoleReviewer);
  public AgentModeAddRoleReviewer() : base() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepAgentModeAddRoleReviewer, $"{PDPSS.AppOwnerNameShort}: Add NPDS Reviewer Role");
