...
public class CoreWebLibTest : TkgcPageController
{
  private const string rzrClass = nameof(CoreWebLibTest);
  public CoreWebLibTest() : base() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepCoreWebLibTest, PdpSitePathKey);
    PSRM.InitRazorPageMenus("_CoreWebLibDebugPageMenu");
