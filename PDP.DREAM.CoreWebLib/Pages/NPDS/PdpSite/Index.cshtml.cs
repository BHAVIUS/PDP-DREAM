...
public class PdpSiteIndex : CoreDataRazorPageControllerBase
{
  private const string rzrCntrllr = nameof(PdpSiteIndex);
  public PdpSiteIndex(QebIdentityContext? userCntxt = null, CoreDbsqlContext? npdsCntxt = null,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSR = new PdpSiteRazorModel(DepPdpSiteIndex, $"{PDPSS.AppOwnerShortName}: PdpSite Index");
