...
public class AdminModeIndex : CoreDataRazorPageControllerBase
{
  private const string rzrCntrllr = nameof(AdminModeIndex);
  public AdminModeIndex(QebIdentityContext? userCntxt = null, CoreDbsqlContext? npdsCntxt = null,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSR = new PdpSiteRazorModel(DepAdminModeIndex,
       $"{PDPSS.AppOwnerShortName}: Admin Mode"); 
