...
public class AdminModeEditQebiUsers : QebiDataRazorPageControllerBase
{
  private const string rzrClass = nameof(AdminModeEditQebiUsers);
  public AdminModeEditQebiUsers() : base() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepAdminModeEditQebiUsers, $"{PDPSS.AppOwnerNameShort}: Edit QEBI Users");
