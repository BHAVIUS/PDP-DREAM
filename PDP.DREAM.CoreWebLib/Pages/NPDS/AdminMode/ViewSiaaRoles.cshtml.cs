...
public class AdminModeViewSiaaRoles : CoreDataRazorPageControllerBase
{
  private const string rzrCntrllr = nameof(AdminModeViewSiaaRoles);
  public AdminModeViewSiaaRoles(QebIdentityContext? userCntxt = null, CoreDbsqlContext? npdsCntxt = null,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSR = new PdpSiteRazorModel(DepAdminModeViewSiaaRoles,
