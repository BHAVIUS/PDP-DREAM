...
public class AdminModeEditSiaaRoles : CoreDataRazorPageControllerBase
{
  private const string rzrCntrllr = nameof(AdminModeEditSiaaRoles);
  public AdminModeEditSiaaRoles(QebIdentityContext? userCntxt = null, CoreDbsqlContext? npdsCntxt = null,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSR = new PdpSiteRazorModel(DepAdminModeEditSiaaRoles,
