...
public class ReviewerModeHelp : QebiDataRazorPageControllerBase
{
  private const string rzrClass = nameof(ReviewerModeHelp);
  public ReviewerModeHelp() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepReviewerModeHelp, $"{PDPSS.AppOwnerNameShort}: Reviewer Help");
