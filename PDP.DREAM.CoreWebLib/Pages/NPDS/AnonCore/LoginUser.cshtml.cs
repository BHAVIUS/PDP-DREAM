...
public class AnonCoreLoginUser : CoreDataRazorPageControllerBase
{
  private const string rzrCntrllr = nameof(AnonCoreLoginUser);
  public AnonCoreLoginUser(QebIdentityContext? userCntxt = null, CoreDbsqlContext? npdsCntxt = null,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSR = new PdpSiteRazorModel(DepAnonCoreLoginUser, $"{PDPSS.AppOwnerShortName}: Login User");
