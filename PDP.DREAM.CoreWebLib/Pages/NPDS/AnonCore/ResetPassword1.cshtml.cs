...
public class AnonCoreResetPassword1 : CoreDataRazorPageControllerBase
{
  private const string rzrCntrllr = nameof(AnonCoreResetPassword1);
  public AnonCoreResetPassword1(QebIdentityContext? userCntxt = null, CoreDbsqlContext? npdsCntxt = null,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSR = new PdpSiteRazorModel("/NPDS/AnonCore/ResetPassword1",
  ...
  public IActionResult OnGet(string id, string ct)
  {
    ...
    {
      return RedirectToPage("/NPDS/AnonCore/ResetPassword3", new { id = id, ct = ct });
    }
    else
    {
  ...
  public IActionResult OnPost()
  {
    ...
    {
      return RedirectToPage("/NPDS/AnonCore/ResetPassword2", new { username = UXM.UserName });
    }
