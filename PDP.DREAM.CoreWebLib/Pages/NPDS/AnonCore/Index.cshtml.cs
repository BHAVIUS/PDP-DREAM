...
public class AnonCoreIndex : CoreDataRazorPageControllerBase
{
  private const string rzrCntrllr = nameof(AnonCoreIndex);
  public AnonCoreIndex(QebIdentityContext? userCntxt = null, CoreDbsqlContext? npdsCntxt = null,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSR = new PdpSiteRazorModel(DepAnonCoreIndex,
      $"{PDPSS.AppOwnerShortName}: Anonymous User");
