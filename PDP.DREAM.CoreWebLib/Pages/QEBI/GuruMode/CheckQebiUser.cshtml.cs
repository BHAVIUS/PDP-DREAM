...
public class GuruModeCheckQebiUser : QebiDataRazorPageControllerBase
{
  private const string rzrClass = nameof(GuruModeCheckQebiUser);
  public GuruModeCheckQebiUser() : base() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepGuruModeCheckQebiUser, $"{PDPSS.AppOwnerNameShort}: Check QEBI User");
