...
public class GuruModeEditQebiRoles : QebiDataRazorPageControllerBase
{
  private const string rzrClass = nameof(GuruModeEditQebiRoles);
  public GuruModeEditQebiRoles() : base() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepGuruModeEditQebiRoles, $"{PDPSS.AppOwnerNameShort}: Edit QEBI Roles");
