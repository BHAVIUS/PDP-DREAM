...
public class UserModeIndex : QebiDataRazorPageControllerBase
{
  private const string rzrClass = nameof(UserModeIndex);
  public UserModeIndex() : base() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepUserModeIndex, $"{PDPSS.AppOwnerNameShort}: User Mode");
