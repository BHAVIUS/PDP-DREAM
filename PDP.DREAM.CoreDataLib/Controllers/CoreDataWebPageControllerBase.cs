...
public abstract class CoreDataWebPageControllerBase : PdpPrcWebPageControllerBase
{
  ...
  public CoreDataWebPageControllerBase()
  {
    pdpCoreDataCntxt = new CoreDbsqlContext(npdsSrvcDefs.NpdsCoreDbconstr);
  }
  public CoreDataWebPageControllerBase(CoreDbsqlContext coreCntxt)
  {
  ...
  public override void OnPageHandlerExecuted(PageHandlerExecutedContext oaeCntxt)
  {
    ...
    { throw new NullReferenceException($"pdpRestCntxt is null in {nameof(CoreDataWebPageControllerBase)} OnActionExecuted()."); }
