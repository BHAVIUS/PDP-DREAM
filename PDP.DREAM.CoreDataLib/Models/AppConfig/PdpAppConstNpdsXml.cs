...
public static partial class PdpAppConst
{
  ...
  public const string NpdsNamespace = "http://npds.portaldoors.org/schema/pdp/npds#"; // target namespace in lowercase
  public const string NpdsXmlSchema = "NPDS.xsd"; // schema filename in uppercase
  public const string NpdsXsdPath = "/pub/xsd/";
  // in the copyright string a "&169;" character does not display in output unless in XHTML
  public const string NpdsCopyright = "Nexus-PORTAL-DOORS-Scribe Cyberinfrastructure System (c) 2006-2024 Carl Taswell and the PORTAL-DOORS Project Team";
  // TODO: implement dynamic lookup from *.xsd schema file ???
  public const string NpdsVersion = "2.3.1 (2023-09-04)";
  ...
  public const string ItemDefaultXnam = "ResrepRecord";
  ...
  // Npds InfoSubSet (aka facet) Index Priority and Count
  public const string ItemFacetIndexXnam = "Index";
  public const string ItemFacetPriorityXnam = "Priority";
  public const string ListFacetCountXnam = "Count";
  ...
  public const string LocationExtnItemXnam = "LocationExtn";
  public const string LocationExtnListXnam = "LocationExtns";
  ...
  public const string RecordUpdatedOnXnam = "UpdatedOn";
