...
{
  public NpdsNexusServerItem() : base() { this.Initialize(NPDSCD.ResrepFormatNexus); }
  public NpdsNexusServerItem(NpdsResrepFormat rrf) : base() { this.Initialize(rrf); }

  private void Initialize(NpdsResrepFormat rrf)
  {
    base.InitNpdsItem(NpdsFieldRule.Required, NexusServerXnam);
  }
  ...
  public override void WriteXml(XmlWriter xWriter)
  {
    ...
    if (writer.WRACE.NexusRecords != null)
    {
      writer.WRACE.NexusRecords.WriteXml(writer);
    }
