...
{
  public NpdsCoreServerItem() : base() { this.Initialize(NPDSCD.ResrepFormatCore); }
  public NpdsCoreServerItem(NpdsResrepFormat rrf) : base() { this.Initialize(rrf); }

  private void Initialize(NpdsResrepFormat rrf)
  {
    base.InitNpdsItem(NpdsFieldRule.Required, CoreServerXnam);
  }
  ...
  public override void WriteXml(XmlWriter xWriter)
  {
    ...
    if (writer.WRACE.CoreRecords != null)
    {
      writer.WRACE.CoreRecords.WriteXml(writer);
    }
