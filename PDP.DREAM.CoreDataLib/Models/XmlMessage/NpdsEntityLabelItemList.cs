...
public class NpdsEntityLabelItem : ANpdsXsgBaseItem<string>
{
  ...
  public NpdsEntityLabelItem(PdpAppConst.NpdsFieldRule rul) : base() { this.Initialize(rul); }
  public NpdsEntityLabelItem(PdpAppConst.NpdsFieldRule rul, string val) : base(val) { this.Initialize(rul); }
  ...
  public override void ReadXml(XmlReader xReader)
  {
    ...
    else if (reader.IsStartElement(ItemXnam))
    {
      ...
      EntityLabel = ReadItemPropAsString(PdpAppConst.EntityLabelItemXnam, reader);
      reader.Read();
    }
  }
}
...
public class NpdsEntityLabelList : ANpdsXsgItemList<NpdsEntityLabelItem>
{
  ...
  public NpdsEntityLabelList(PdpAppConst.NpdsFieldRule rul) : base(rul) { }
}
