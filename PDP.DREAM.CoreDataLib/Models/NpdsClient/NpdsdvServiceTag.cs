...
public partial class NpdsClientWrace
{
  ...
  private string reqServiceTag = ESS;
  ...
  public string? ServiceTag
  {
    set {
      ...
      if (!string.IsNullOrEmpty(serviceTag))
      {
        ...
        {
          case DdeSearchFilter.Diristry: // Nexus
            DiristryTag = serviceTag; // also resets DiristryGuid
            break;
          case DdeSearchFilter.Registry: // PORTAL
            RegistryTag = serviceTag; // also resets RegistryGuid
            break;
          case DdeSearchFilter.Directory: // DOORS
            DirectoryTag = serviceTag; // also resets DirectoryGuid
            break;
          case DdeSearchFilter.Registrar: // Scribe
            RegistrarTag = serviceTag; // also resets RegistrarGuid
            break;
          case DdeSearchFilter.Services: // Core Components, not Core Constituents
            DiristryTag = serviceTag; // also resets DiristryGuid
            break;
          default:
  ...
  private string ValidateServiceTag(string reqTag)
  {
    ...
    // ATTN: prioritize this TODO on service cache lookup and generalized dynamic lookup
    ...
    if (!string.IsNullOrEmpty(reqTag))
    {
      ...
      switch (reqTag)
      {
        ...
        case "NLMMESH":
          ...
          DbcnstrNexus = NPDSCD.VocabDbconstr;
