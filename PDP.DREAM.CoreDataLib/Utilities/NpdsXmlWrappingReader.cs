...
public class NpdsXmlWrappingReader : XmlReader, IXmlLineInfo
{
  ...
  public NpdsXmlWrappingReader(NpdsClientWrace context, XmlReader reader)
  { WRACE = context; baseXmlReader = reader; }
  public NpdsXmlWrappingReader(NpdsClientWrace context, TextReader reader)
  { WRACE = context; baseXmlReader = Create(reader); }
  public NpdsXmlWrappingReader(NpdsClientWrace context, Stream inputStream)
  { WRACE = context; baseXmlReader = Create(inputStream); }
  public NpdsXmlWrappingReader(NpdsClientWrace context, XmlReader reader, XmlReaderSettings settings)
  { WRACE = context; baseXmlReader = Create(reader, settings); }
  public NpdsXmlWrappingReader(NpdsClientWrace context, TextReader reader, XmlReaderSettings settings)
  { WRACE = context; baseXmlReader = Create(reader, settings); }
  public NpdsXmlWrappingReader(NpdsClientWrace context, Stream inputStream, XmlReaderSettings settings)
  { WRACE = context; baseXmlReader = Create(inputStream, settings); }
  public NpdsXmlWrappingReader(NpdsClientWrace context, string inputUri, XmlReaderSettings settings)
  { WRACE = context; baseXmlReader = Create(inputUri, settings); }
