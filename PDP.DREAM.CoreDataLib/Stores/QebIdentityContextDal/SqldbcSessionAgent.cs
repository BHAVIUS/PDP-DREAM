...
{
  public bool EditNpdsAgentSession(ref QebUserRestContext qurc)
  {
  ...
  public bool CheckNpdsAgentSession(ref QebUserRestContext qurc)
  {
    if (!PdpGuid.IsInvalidGuid(PDPSS.AppSecureUiaaGuid) && !PdpGuid.IsInvalidGuid(qurc.QebUserGuid))
    {
      OpenSqlConnection();
  ...
  public bool NpdsAgentSessionAddRole(NamesForIdentityRoles role)
  {
    var roleAdded = false;
