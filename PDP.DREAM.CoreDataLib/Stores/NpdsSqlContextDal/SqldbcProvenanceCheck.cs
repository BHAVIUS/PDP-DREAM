...
{
  public virtual ProvenanceUxm CheckProvenance(ProvenanceUxm editObj)
  {
    var errMsg = ESS;
  ...
  public virtual byte CheckProvenances(Guid recordGuid)
  {
    var rrr = GetEditableResrepLeafByRKey(recordGuid);
    return CheckProvenances(ref rrr);
  }
  public virtual byte CheckProvenances(ref CoreResrepLeafUxm rrr)
  {
    byte statusCode = 0;
  ...
  public ProvenanceUxm ReseqProvenance(ProvenanceUxm ssEdit)
  {
    var errMsg = ESS;
    var agentGuid = NPDSDC.NpdsAgentGuid;
