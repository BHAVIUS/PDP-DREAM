...
{
  public virtual CrossReferenceUxm CheckCrossReference(CrossReferenceUxm editObj)
  {
    var errMsg = ESS;
  ...
  public virtual byte CheckCrossReferences(Guid recordGuid)
  {
    var rrr = GetEditableResrepLeafByRKey(recordGuid);
    return CheckCrossReferences(ref rrr);
  }
  public virtual byte CheckCrossReferences(ref CoreResrepLeafUxm rrr)
  {
    byte statusCode = 0;
  ...
  public CrossReferenceUxm ReseqCrossReference(CrossReferenceUxm ssEdit)
  {
    var errMsg = ESS;
    var agentGuid = NPDSDC.NpdsAgentGuid;
