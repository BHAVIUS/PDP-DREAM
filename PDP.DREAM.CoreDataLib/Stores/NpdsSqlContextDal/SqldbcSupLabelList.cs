...
{
  public IEnumerable<SupportingLabelUxm> ListEditableSupportingLabels(Guid guidKey, bool isLimited = false)
  {
    IEnumerable<SupportingLabelUxm> result;
    try
    {
    ...
    {
      result = Enumerable.Empty<SupportingLabelUxm>();
    }
    return result;
  }
