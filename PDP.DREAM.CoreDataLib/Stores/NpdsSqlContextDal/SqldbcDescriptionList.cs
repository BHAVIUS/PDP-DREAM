...
{
  public IEnumerable<DescriptionUxm?> ListEditableDescriptions(Guid guidKey, bool isLimited = false)
  {
    IEnumerable<DescriptionUxm?> result;
    try
    {
    ...
    {
      result = Enumerable.Empty<DescriptionUxm?>();
    }
    return result;
  }
