...
{
  public static IQueryable<DescriptionExtnUxm?> ToEditable(this IQueryable<DoorsDescriptionExtn?> query)
  {
    IQueryable<DescriptionExtnUxm?> rows =
      from r in query
      select new DescriptionExtnUxm
      {
