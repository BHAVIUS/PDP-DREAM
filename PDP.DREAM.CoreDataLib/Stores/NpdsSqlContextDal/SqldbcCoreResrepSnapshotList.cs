...
{
  public IEnumerable<ResrepSnapshotUxm> ListEditableResrepSnapshots(Guid guidKey, bool isLimited = false)
  {
    IEnumerable<ResrepSnapshotUxm> result;
    try
    {
    ...
    {
      result = Enumerable.Empty<ResrepSnapshotUxm>();
    }
    return result;
  }
