...
{
  public IEnumerable<CrossReferenceUxm> ListEditableCrossReferences(Guid guidKey, bool isLimited = false)
  {
    IEnumerable<CrossReferenceUxm> result;
    try
    {
    ...
    {
      result = Enumerable.Empty<CrossReferenceUxm>();
    }
    return result;
  }
