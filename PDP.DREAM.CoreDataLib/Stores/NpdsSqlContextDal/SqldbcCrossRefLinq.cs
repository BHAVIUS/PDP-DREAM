...
{
  public static IQueryable<CrossReferenceUxm> ToEditable(this IQueryable<PortalCrossReference> query)
  {
    IQueryable<CrossReferenceUxm> rows =
      from r in query
      select new CrossReferenceUxm
      {
