...
namespace PDP.DREAM.CoreDataLib.Stores
{
    ...
    public partial class CoreServiceRestrictionOrConfiguration : IEntityTypeConfiguration<CoreServiceRestrictionOr>
    {
        ...
        {
            builder.ToTable(@"CoreServiceRestrictionOr", @"dbo");
            ...
            builder.Property(x => x.AndHasIndex).HasColumnName(@"AndHasIndex").HasColumnType(@"tinyint").ValueGeneratedNever().HasPrecision(3, 0);
            builder.Property(x => x.AndHasPriority).HasColumnName(@"AndHasPriority").HasColumnType(@"tinyint").IsRequired().ValueGeneratedNever().HasPrecision(5, 0);
            ...
            builder.Property(x => x.OrHasPriority).HasColumnName(@"OrHasPriority").HasColumnType(@"tinyint").IsRequired().ValueGeneratedNever().HasPrecision(5, 0);
            builder.Property(x => x.OrHasIndex).HasColumnName(@"OrHasIndex").HasColumnType(@"tinyint").ValueGeneratedNever().HasPrecision(3, 0);
