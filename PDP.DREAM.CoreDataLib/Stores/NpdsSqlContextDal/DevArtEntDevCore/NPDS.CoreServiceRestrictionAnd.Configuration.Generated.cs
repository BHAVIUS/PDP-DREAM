...
namespace PDP.DREAM.CoreDataLib.Stores
{
    ...
    public partial class CoreServiceRestrictionAndConfiguration : IEntityTypeConfiguration<CoreServiceRestrictionAnd>
    {
        ...
        {
            builder.ToTable(@"CoreServiceRestrictionAnd", @"dbo");
            ...
            builder.HasOne(x => x.CoreResrepLeaf).WithMany(op => op.CoreServiceRestrictionAnds).HasForeignKey(@"RecordGuid").IsRequired(true);
            builder.HasOne(x => x.CoreResrepRoot).WithMany(op => op.CoreServiceRestrictionAnds).HasForeignKey(@"RecordGuid").IsRequired(true);
