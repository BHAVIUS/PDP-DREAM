...
namespace PDP.DREAM.CoreDataLib.Stores
{
    ...
    public partial class CoreServiceDefaultConfiguration : IEntityTypeConfiguration<CoreServiceDefault>
    {
        ...
        public void Configure(EntityTypeBuilder<CoreServiceDefault> builder)
        {
            ...
            builder.Property(x => x.ServiceNature).HasColumnName(@"ServiceNature").HasColumnType(@"nvarchar(1024)").IsRequired().ValueGeneratedNever().HasMaxLength(1024);
            ...
            builder.Property(x => x.ServiceTCode).HasColumnName(@"ServiceTCode").HasColumnType(@"tinyint").IsRequired().ValueGeneratedNever().HasPrecision(5, 0);
