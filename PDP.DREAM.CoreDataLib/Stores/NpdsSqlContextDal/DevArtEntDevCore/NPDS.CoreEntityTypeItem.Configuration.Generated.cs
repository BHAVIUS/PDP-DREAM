...
namespace PDP.DREAM.CoreDataLib.Stores
{
    ...
    public partial class CoreEntityTypeItemConfiguration : IEntityTypeConfiguration<CoreEntityTypeItem>
    {
        ...
        public void Configure(EntityTypeBuilder<CoreEntityTypeItem> builder)
        {
            ...
            builder.Property(x => x.TypeEditedByReviewer).HasColumnName(@"TypeEditedByReviewer").HasColumnType(@"bit").IsRequired().ValueGeneratedNever();
            ...
            builder.HasOne(x => x.CoreResrepRoot).WithMany(op => op.CoreEntityTypeItems).HasPrincipalKey(@"EntityTypeCode").HasForeignKey(@"CodeKey").IsRequired(true);
