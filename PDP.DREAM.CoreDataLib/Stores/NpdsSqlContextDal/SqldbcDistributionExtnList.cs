...
{
  public IEnumerable<DistributionExtnUxm> ListEditableDistributionExtns(Guid guidKey, bool isLimited = false)
  {
    IEnumerable<DistributionExtnUxm> result;
    try
    {
    ...
    {
      result = Enumerable.Empty<DistributionExtnUxm>();
    }
    return result;
  }
