...
{
  public IEnumerable<DistributionUxm> ListEditableDistributions(Guid guidKey, bool isLimited = false)
  {
    IEnumerable<DistributionUxm> result;
    try
    {
    ...
    {
      result = Enumerable.Empty<DistributionUxm>();
    }
    return result;
  }
