...
{
  public static IQueryable<ResrepSnapshotUxm> ToEditable(this IQueryable<CoreResrepSnapshot> query)
  {
    IQueryable<ResrepSnapshotUxm> rows =
      from r in query
      select new ResrepSnapshotUxm
      {
        ...
        //
        ResrepSnapshot = r.ResrepSnapshotXml
      };
    return rows;
  }
