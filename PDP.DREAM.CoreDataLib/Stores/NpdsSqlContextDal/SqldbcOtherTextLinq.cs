...
{
  public static IQueryable<OtherTextUxm> ToEditable(this IQueryable<PortalOtherText> query)
  {
    IQueryable<OtherTextUxm> rows =
      from r in query
      select new OtherTextUxm
      {
