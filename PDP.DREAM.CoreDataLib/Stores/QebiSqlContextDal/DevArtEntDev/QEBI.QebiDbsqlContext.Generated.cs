...
namespace PDP.DREAM.CoreDataLib.Stores
{
    ...
    public partial class QebiDbsqlContext : PDP.DREAM.CoreDataLib.Stores.DbsqlContextBase
    {
        ...
        public virtual DbSet<QebIdentityAppUserSession> QebIdentityAppUserSessions
        {
            get;
            set;
        }
        ...
        public int? QebIdentityAppUserApprove (Guid? AppGuidRef, Guid? UserGuidKey, bool? UserIsApproved)
        {
            ...
            try
            {
                using (DbCommand cmd = connection.CreateCommand())
                {
                    if (this.Database.GetCommandTimeout().HasValue)
                        cmd.CommandTimeout = this.Database.GetCommandTimeout().Value;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.CommandText = @"dbo.QebIdentityAppUserApprove";
        ...
        public async Task<int?> QebIdentityAppUserApproveAsync (Guid? AppGuidRef, Guid? UserGuidKey, bool? UserIsApproved)
        {
        ...
        public int? QebIdentityAppLinkDelete (Guid? LinkGuidKey, Guid? AppGuidRef)
        {
            ...
            try
            {
                using (DbCommand cmd = connection.CreateCommand())
                {
                    if (this.Database.GetCommandTimeout().HasValue)
                        cmd.CommandTimeout = this.Database.GetCommandTimeout().Value;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.CommandText = @"dbo.QebIdentityAppLinkDelete";
        ...
        public async Task<int?> QebIdentityAppLinkDeleteAsync (Guid? LinkGuidKey, Guid? AppGuidRef)
        {
        ...
        public int? QebiAppUserSessionCheck (Guid? AppGuid, bool? SessionValueIsRequired, ref Guid? SessionGuid, ref Guid? UserGuid, ref Guid? AgentGuid, ref string UserNameDisp, ref bool? UserIsAgent, ref bool? AgentIsAuthor, ref bool? AgentIsEditor, ref bool? AgentIsAdmin)
        {
            ...
            try
            {
                using (DbCommand cmd = connection.CreateCommand())
                {
                    if (this.Database.GetCommandTimeout().HasValue)
                        cmd.CommandTimeout = this.Database.GetCommandTimeout().Value;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.CommandText = @"dbo.QebiAppUserSessionCheck";
                    ...
                    DbParameter UserNameDispParameter = cmd.CreateParameter();
                    UserNameDispParameter.ParameterName = "UserNameDisp";
                    UserNameDispParameter.Direction = ParameterDirection.InputOutput;
                    UserNameDispParameter.DbType = DbType.String;
                    UserNameDispParameter.Size = 64;
                    if (UserNameDisp != null)
                    {
                        UserNameDispParameter.Value = UserNameDisp;
                    }
                    else
                    {
                        UserNameDispParameter.Value = DBNull.Value;
                    }
                    cmd.Parameters.Add(UserNameDispParameter);
                    ...
                    if (cmd.Parameters["UserNameDisp"].Value != null && !(cmd.Parameters["UserNameDisp"].Value is System.DBNull))
                        UserNameDisp = (string)Convert.ChangeType(cmd.Parameters["UserNameDisp"].Value, typeof(string));
                    else
                        UserNameDisp = default(string);
        ...
        public int? QebiAppUserSessionEdit (Guid? AppGuid, Guid? UserGuid, ref Guid? SessionGuid)
        {
            ...
            try
            {
                using (DbCommand cmd = connection.CreateCommand())
                {
                    if (this.Database.GetCommandTimeout().HasValue)
                        cmd.CommandTimeout = this.Database.GetCommandTimeout().Value;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.CommandText = @"dbo.QebiAppUserSessionEdit";
        ...
        public int? QebiAppUserSessionTimestamp (Guid? UserGuid, Guid? SessionGuid)
        {
            ...
            try
            {
                using (DbCommand cmd = connection.CreateCommand())
                {
                    if (this.Database.GetCommandTimeout().HasValue)
                        cmd.CommandTimeout = this.Database.GetCommandTimeout().Value;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.CommandText = @"dbo.QebiAppUserSessionTimestamp";
                    ...
                    DbParameter SessionGuidParameter = cmd.CreateParameter();
                    SessionGuidParameter.ParameterName = "SessionGuid";
                    SessionGuidParameter.Direction = ParameterDirection.Input;
                    SessionGuidParameter.DbType = DbType.Guid;
                    if (SessionGuid.HasValue)
                    {
                        SessionGuidParameter.Value = SessionGuid.Value;
        ...
        public int? QebiAppUserAgentRoleEdit (Guid? AppGuid, Guid? UserGuid, Guid? AgentGuid, bool? UserIsAgent, bool? AgentIsAuthor, bool? AgentIsEditor, bool? AgentIsAdmin)
        {
            ...
            try
            {
                using (DbCommand cmd = connection.CreateCommand())
                {
                    if (this.Database.GetCommandTimeout().HasValue)
                        cmd.CommandTimeout = this.Database.GetCommandTimeout().Value;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.CommandText = @"dbo.QebiAppUserAgentRoleEdit";
                    ...
                    DbParameter UserIsAgentParameter = cmd.CreateParameter();
                    UserIsAgentParameter.ParameterName = "UserIsAgent";
                    UserIsAgentParameter.Direction = ParameterDirection.Input;
                    UserIsAgentParameter.DbType = DbType.Boolean;
                    if (UserIsAgent.HasValue)
                    {
                        UserIsAgentParameter.Value = UserIsAgent.Value;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration<QebIdentityAppUserSession>(new QebIdentityAppUserSessionConfiguration());
