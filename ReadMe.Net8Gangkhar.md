...
PDP-DREAM Public Repository: most recent public version of Aoraki, Cervin, or Gangkhar branches  


This Branch Version: public Net8Gangkhar v11.4.14  
DevTested Package: Telerik.UI.for.AspNet.Core.2024.1.319.nupkg  
DevTested Database: Microsoft SQL Server 2022 v16.0.4120.1  
DevTested Environment: Microsoft Visual Studio 17.9.6  
Current DotNet Target: .NET Runtime 8.0.4 with SDK 8.0.204  
DevTested Branch Net6Aoraki: web apps with Telerik UI for ASP.Net Core MVC Views  
DevTested Branch Net7Cervin: web apps with Telerik UI for ASP.Net Core MVC Views and Razor Pages  
DevTested Branch Net8Gangkhar: web apps with Telerik UI for ASP.Net Core RazorPages  
DevTested Branch Net9Aoraki: web apps with Telerik UI for ASP.Net Core RazorPages and Blazor Components  
DevTested Branch Net10Cervin: web apps with Telerik UI for ASP.Net Core Blazor Components  
DevTested Branch Net11Gangkhar: ?TBD? desktop/mobile/web apps with Telerik UI for WinUI, MAUI, or AvaloniaUI  
...
* PDP.DREAM.CoreDataLib for ACGT

where  
A is Aoraki on Net 6 with MVC Views, fall 2022,  
C is Cervin on Net 7 with MVC Views and Razor Pages, spring 2023,  
G is Gangkhar on Net 8 with Razor Pages, spring 2024,  
T is Tahtali on current Net preview for which Tahtali also 
maintains BabbleNewtLib, BabbleBirdLib, AcmsDataLib, AcmsWebLib.  
