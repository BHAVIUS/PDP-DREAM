...
// Code is generated on: 6/29/2022 12:18:34 AM
//
...
namespace PDP.DREAM.ScribeDataLib.Stores
{
    ...
    public partial class ScribeDbsqlContext : PDP.DREAM.NexusDataLib.Stores.NexusDbsqlContext
    {
        ...
        public int? ScribeServiceCoreDefaultDelete (Guid? AgentGuidRef, Guid? RecordGuidRef, Guid? FgroupGuidKey, bool? IsRealDelete)
        {
            ...
            try
            {
                using (DbCommand cmd = connection.CreateCommand())
                {
                    if (this.Database.GetCommandTimeout().HasValue)
                        cmd.CommandTimeout = this.Database.GetCommandTimeout().Value;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.CommandText = @"dbo.ScribeServiceCoreDefaultDelete";
        ...
        public async Task<int?> ScribeServiceCoreDefaultDeleteAsync (Guid? AgentGuidRef, Guid? RecordGuidRef, Guid? FgroupGuidKey, bool? IsRealDelete)
        {
        ...
        public int? ScribeServiceCoreDefaultEdit (Guid? AgentGuidRef, Guid? InfosetGuidRef, Guid? RecordGuidRef, Guid? FgroupGuidKey, short? HasPriority, bool? IsMarked, bool? IsPrincipal, Guid? DiristryIGuidRef, Guid? RegistryIGuidRef, Guid? DirectoryIGuidRef, Guid? RegistrarIGuidRef)
        {
            ...
            try
            {
                using (DbCommand cmd = connection.CreateCommand())
                {
                    if (this.Database.GetCommandTimeout().HasValue)
                        cmd.CommandTimeout = this.Database.GetCommandTimeout().Value;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.CommandText = @"dbo.ScribeServiceCoreDefaultEdit";
        ...
        public async Task<int?> ScribeServiceCoreDefaultEditAsync (Guid? AgentGuidRef, Guid? InfosetGuidRef, Guid? RecordGuidRef, Guid? FgroupGuidKey, short? HasPriority, bool? IsMarked, bool? IsPrincipal, Guid? DiristryIGuidRef, Guid? RegistryIGuidRef, Guid? DirectoryIGuidRef, Guid? RegistrarIGuidRef)
        {
