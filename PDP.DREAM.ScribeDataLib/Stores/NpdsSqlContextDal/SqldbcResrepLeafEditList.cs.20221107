// SqldbcUilResrepLeafEditList.cs 
...
{
  // ListEditables //
  public IList<NexusResrepEditModel?> ListEditableResrepLeafs()
  {
    IQueryable<INexusResrepLeaf> query = InitQueryStorableNexusLeaf();
    IList<NexusResrepEditModel?> list = query.ToEditable().ToList();
    return list;
  }
  public IList<NexusResrepEditModel?> ListEditableResrepLeafs(int pageSize, int pageNumber, out int listCount)
  {
    IQueryable<INexusResrepLeaf> query = InitQueryStorableNexusLeaf();
  ...
  public IList<NexusResrepEditModel?> ListEditableResrepLeafs(DataSourceRequest dsRequest, out int listCount)
  {
