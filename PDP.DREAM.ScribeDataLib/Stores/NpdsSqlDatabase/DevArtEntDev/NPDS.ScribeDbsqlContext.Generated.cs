...
// Code is generated on: 2021-11-15 12:36:36
//
...
namespace PDP.DREAM.ScribeDataLib.Stores
{
    ...
    public partial class ScribeDbsqlContext : PDP.DREAM.NexusDataLib.Stores.NexusDbsqlContext
    {
        ...
        public int? ScribeAgentSessionAddRole (Guid? UserGuid, Guid? AgentGuid, bool? IsAuthor, bool? IsEditor, bool? IsAdmin)
        {
            ...
            try
            {
                using (DbCommand cmd = connection.CreateCommand())
                {
                    if (this.Database.GetCommandTimeout().HasValue)
                        cmd.CommandTimeout = this.Database.GetCommandTimeout().Value;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.CommandText = @"dbo.ScribeAgentSessionAddRole";
                    ...
                    DbParameter IsAuthorParameter = cmd.CreateParameter();
                    IsAuthorParameter.ParameterName = "IsAuthor";
                    IsAuthorParameter.Direction = ParameterDirection.Input;
                    IsAuthorParameter.DbType = DbType.Boolean;
                    if (IsAuthor.HasValue)
                    {
                        IsAuthorParameter.Value = IsAuthor.Value;
                    }
                    else
                    {
                        IsAuthorParameter.Size = -1;
                        IsAuthorParameter.Value = DBNull.Value;
                    }
                    cmd.Parameters.Add(IsAuthorParameter);

                    DbParameter IsEditorParameter = cmd.CreateParameter();
                    IsEditorParameter.ParameterName = "IsEditor";
                    IsEditorParameter.Direction = ParameterDirection.Input;
                    IsEditorParameter.DbType = DbType.Boolean;
                    if (IsEditor.HasValue)
                    {
                        IsEditorParameter.Value = IsEditor.Value;
                    }
                    else
                    {
                        IsEditorParameter.Size = -1;
                        IsEditorParameter.Value = DBNull.Value;
                    }
                    cmd.Parameters.Add(IsEditorParameter);

                    DbParameter IsAdminParameter = cmd.CreateParameter();
                    IsAdminParameter.ParameterName = "IsAdmin";
                    IsAdminParameter.Direction = ParameterDirection.Input;
                    IsAdminParameter.DbType = DbType.Boolean;
                    if (IsAdmin.HasValue)
                    {
                        IsAdminParameter.Value = IsAdmin.Value;
                    }
                    else
                    {
                        IsAdminParameter.Size = -1;
                        IsAdminParameter.Value = DBNull.Value;
                    }
        ...
        public async Task<int?> ScribeAgentSessionAddRoleAsync (Guid? UserGuid, Guid? AgentGuid, bool? IsAuthor, bool? IsEditor, bool? IsAdmin)
        {
