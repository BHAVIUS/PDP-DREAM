...
{
  public class DreamExampleEditModel : NexusEditModelBase
  {
    public DreamExampleEditModel() { }
    public Guid RegistrarGuid { get; } = NpdsServiceDefaults.Values.NpdsServiceCache.GetByTag("PDP-Scribe");
    public Guid DiristryGuid { get; } = NpdsServiceDefaults.Values.NpdsServiceCache.GetByTag("PDP-DREAM");
