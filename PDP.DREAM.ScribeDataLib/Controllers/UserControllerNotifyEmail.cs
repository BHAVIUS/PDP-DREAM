...
public partial class UserScribeController
{
  ...
  protected ChangeEmailUxm NotifyEmailWithToken(ChangeEmailUxm uxm)
  {
    try
    {
      ...
      var link = LinkToConfirmToken(uxm.UserName, uxm.SecurityToken, "ConfirmEmail", "AnonScribe", "NPDS");
      ...
      var mail = uxm.NewEmail ?? PdpSiteSettings.Values.AppHostEmail;
