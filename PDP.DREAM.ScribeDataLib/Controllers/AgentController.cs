...
public partial class AgentScribeController : UserScribeController
{
  public AgentScribeController(QebIdentityContext userCntxt, ScribeDbsqlContext npdsCntxt,
  ...
  {
    var appGuid = PdpSiteSettings.Values.AppSecureUiaaGuid;
