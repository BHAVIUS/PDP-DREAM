...
public partial class TkgnPageController
{
  ...
  public JsonResult OnPostReadDescriptions([DataSourceRequest] DataSourceRequest dsRequest,
   string serviceTag, Guid recordGuid, bool isLimited = false)
  {
    ...
    {
      dsResult = NPDSCW.PNDC.ListEditableDescriptions(recordGuid, isLimited)
