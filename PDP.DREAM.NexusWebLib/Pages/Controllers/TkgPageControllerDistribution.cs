...
public partial class TkgnPageController
{
  ...
  public JsonResult OnPostReadDistributions([DataSourceRequest] DataSourceRequest dsRequest,
   string serviceTag, Guid recordGuid, bool isLimited = false)
  {
    ...
    {
      dsResult = NPDSCW.PNDC.ListEditableDistributions(recordGuid, isLimited)
