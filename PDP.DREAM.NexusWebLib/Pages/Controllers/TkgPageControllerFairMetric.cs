...
public partial class TkgnPageController
{
  ...
  public JsonResult OnPostReadFairMetrics([DataSourceRequest] DataSourceRequest dsRequest,
   string serviceTag, Guid recordGuid, bool isLimited = false)
  {
    ...
    {
      dsResult = NPDSCW.PNDC.ListEditableFairMetrics(recordGuid, isLimited)
