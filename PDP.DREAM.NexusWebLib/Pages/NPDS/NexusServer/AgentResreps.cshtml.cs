...
public class NexusServerAgentResreps : TkgnPageController
{
  private const string rzrClass = nameof(NexusServerAgentResreps);
  public NexusServerAgentResreps() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepNexusServerAgentResreps, PdpSitePathKey);
