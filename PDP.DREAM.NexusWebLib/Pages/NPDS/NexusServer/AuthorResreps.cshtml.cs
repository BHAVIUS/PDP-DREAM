...
public class NexusServerAuthorResreps : TkgnPageController
{
  private const string rzrClass = nameof(NexusServerAuthorResreps);
  public NexusServerAuthorResreps()  { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepNexusServerAuthorResreps, PdpSitePathKey);
