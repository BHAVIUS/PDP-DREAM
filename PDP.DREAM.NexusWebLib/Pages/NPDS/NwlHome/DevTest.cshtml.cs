...
public class NwlHomeDevTest : TkgnPageController
{
  private const string rzrClass = nameof(NwlHomeDevTest);
  public NwlHomeDevTest() : base() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepNwlHomeDevTest, PdpSitePathKey);
    PSRM.InitRazorPageMenus("_NexusWebLibSpanPageMenu", "_NexusWebLibDebugPageMenu");
