...
public class NwlHomeAuthorHelp : TkgnPageControllerBase
{
  private const string rzrCntrllr = nameof(NwlHomeAuthorHelp);
  public NwlHomeAuthorHelp(QebIdentityContext userCntxt,
    NexusDbsqlContext npdsCntxt) : base(userCntxt, npdsCntxt) { }

  // OnPageHandlerExecuting before OnGet
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    PSR = new PdpSiteRazorModel("/NPDS/NwlHome/AuthorHelp", PdpSitePathKey);
