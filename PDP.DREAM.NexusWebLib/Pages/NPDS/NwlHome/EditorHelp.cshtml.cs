...
public class NwlHomeEditorHelp : TkgnPageControllerBase
{
  private const string rzrCntrllr = nameof(NwlHomeEditorHelp);
  public NwlHomeEditorHelp(QebIdentityContext userCntxt,
    NexusDbsqlContext npdsCntxt) : base(userCntxt, npdsCntxt) { }

  // OnPageHandlerExecuting before OnGet
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    PSR = new PdpSiteRazorModel("/NPDS/NwlHome/EditorHelp", PdpSitePathKey);
