...
public class NwlHomeEditorHelp : TkgnPageController
{
  private const string rzrClass = nameof(NwlHomeEditorHelp);
  public NwlHomeEditorHelp() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepNwlHomeEditorHelp, PdpSitePathKey);
