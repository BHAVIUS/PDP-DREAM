...
public class NexusServiceReviewerResreps : TkgnPageController
{
  private const string rzrClass = nameof(NexusServiceReviewerResreps);
  public NexusServiceReviewerResreps() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepNexusServiceReviewerResreps, PdpSitePathKey);
