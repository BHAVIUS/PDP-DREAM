...
public class NexusServiceAdminResreps : TkgnPageController
{
  private const string rzrClass = nameof(NexusServiceAdminResreps);
  public NexusServiceAdminResreps() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepNexusServiceAdminResreps, PdpSitePathKey);
