...
public partial class TkgrControllerBase
{
  ...
  [PdpMvcRoute(nameof(ScribeSelectCrossReferences), "", TSrgil, NPmvc)]
  ...
  [PdpMvcRoute(nameof(ScribeUpsertCrossReference), "", TSrgil, NPmvc)]
  ...
  [PdpMvcRoute(nameof(ScribeDeleteCrossReference), "", TSrgil, NPmvc)]
  ...
  [HttpGet, HttpPost] // Get for Rest, Post for Ajax
  [PdpMvcRoute(nameof(ScribeCheckCrossReference), "", TSrg, NPmvc)]
