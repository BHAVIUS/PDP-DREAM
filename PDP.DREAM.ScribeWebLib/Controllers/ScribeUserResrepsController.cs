// ScribeUserResrepsController.cs 
...
[Area(PdpConst.PdpMvcArea), RequireHttps, Authorize(Roles = PdpConst.NpdsUser)]
public class ScribeUserResrepsController : TkgrControllerBase
{
  public ScribeUserResrepsController(QebIdentityContext userCntxt, ScribeDbsqlContext npdsCntxt) : base(userCntxt, npdsCntxt) { }
  ...
  public override void OnActionExecuted(ActionExecutedContext oaeCntxt)
  {
    ...
    { throw new NullReferenceException($"pdpRestCntxt is null in {nameof(ScribeUserResrepsController)} OnActionExecuted()."); }
    // PDP REST Context in PDP.DREAM.CoreDataLib.Models.PdpRestContext
    pdpRestCntxt.TkgrArea = PdpConst.PdpMvcArea;
    pdpRestCntxt.TkgrController = "ScribeUserResreps";
