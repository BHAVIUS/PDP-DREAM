...
public class ScribeEditorResrepsController : TkgrControllerBase
{
  ...
  public override void OnActionExecuted(ActionExecutedContext oaeCntxt)
  {
    ...
    { throw new NullReferenceException($"pdpRestCntxt is null in {nameof(ScribeEditorResrepsController)} OnActionExecuted()."); }
    // PDP REST Context in PDP.DREAM.CoreDataLib.Models.PdpRestContext
    pdpRestCntxt.TkgrArea = PdpConst.PdpMvcArea;
    pdpRestCntxt.TkgrController = "ScribeEditorResreps";
    pdpRestCntxt.TkgrViewRole = "Editor";
