...
public class ScribeServiceCccResrepFgroups : TkgsPageController
{
  private const string rzrClass = nameof(ScribeServiceCccResrepFgroups);
  public ScribeServiceCccResrepFgroups() : base() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepScribeServiceCccResrepFgroups, PdpSitePathKey);
