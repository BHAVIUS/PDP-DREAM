...
public class ScribeServiceCccResrepRoots : TkgsPageController
{
  private const string rzrClass = nameof(ScribeServiceCccResrepRoots);
  public ScribeServiceCccResrepRoots() : base() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepScribeServiceCccResrepRoots, PdpSitePathKey);
