...
public class ScribeServiceEditorAccess : TkgsPageController
{
  private const string rzrClass = nameof(ScribeServiceEditorAccess);
  public ScribeServiceEditorAccess() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepScribeServiceEditorAccess, PdpSitePathKey);
