...
public class ScribeServiceCccResrepServices : TkgsPageController
{
  private const string rzrClass = nameof(ScribeServiceCccResrepServices);
  public ScribeServiceCccResrepServices() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepScribeServiceCccResrepServices, PdpSitePathKey);
