...
public class ScribeServiceCccEntityLabels : TkgsPageController
{
  private const string rzrClass = nameof(ScribeServiceCccEntityLabels);
  public ScribeServiceCccEntityLabels() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepScribeServiceCccEntityLabels, PdpSitePathKey);
