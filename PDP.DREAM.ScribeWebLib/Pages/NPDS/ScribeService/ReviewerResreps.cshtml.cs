...
[RequireHttps, PdpAuthorizeRoles(NpdsReviewer, NpdsEditor, NpdsAdmin)]
public class ScribeServiceReviewerResreps : TkgsPageController
{
  private const string rzrClass = nameof(ScribeServiceReviewerResreps);
  public ScribeServiceReviewerResreps() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    WRACE = new NpdsClientWrace(exeCntxt.HttpContext)
    {
      ...
      RecordAccess = NPDSCD.RecordAccessReviewer, // resets *ClientModeRequired
      ReviewerModeClientRequired = true,
      SessionClientRequired = true
    };
    // do not include optional params in pageName
    PSRM = new PdpSiteRazorModel(DepScribeServiceReviewerResreps, PdpSitePathKey);
