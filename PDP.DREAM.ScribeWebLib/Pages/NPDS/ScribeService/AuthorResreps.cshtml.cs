...
public class ScribeServiceAuthorResreps : TkgsPageController
{
  private const string rzrClass = nameof(ScribeServiceAuthorResreps);
  public ScribeServiceAuthorResreps() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    WRACE = new NpdsClientWrace(exeCntxt.HttpContext)
    {
      ...
      RecordAccess = NPDSCD.RecordAccessAuthor, // resets *ClientModeRequired
      AuthorModeClientRequired = true,
      SessionClientRequired = true
    };
    // do not include optional params in pageName
    PSRM = new PdpSiteRazorModel(DepScribeServiceAuthorResreps, PdpSitePathKey);
