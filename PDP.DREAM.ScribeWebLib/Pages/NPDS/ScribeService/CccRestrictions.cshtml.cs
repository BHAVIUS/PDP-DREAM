...
public class ScribeServiceCccRestrictions : TkgsPageController
{
  private const string rzrClass = nameof(ScribeServiceCccRestrictions);
  public ScribeServiceCccRestrictions() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepScribeServiceCccRestrictions, PdpSitePathKey);
