...
public class ScribeWebLibHelp : TkgsPageController
{
  private const string rzrClass = nameof(ScribeWebLibHelp);
  public ScribeWebLibHelp() : base() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepScribeWebLibHelp, PdpSitePathKey);
