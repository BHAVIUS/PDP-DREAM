...
public class ScribeServerServiceRestrictionsTest : TkgsPageControllerBase
{
  private const string rzrCntrllr = nameof(ScribeServerServiceRestrictionsTest);
  public ScribeServerServiceRestrictionsTest(QebIdentityContext userCntxt,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSR = new PdpSiteRazorModel("/NPDS/ScribeServer/ServiceRestrictionsTest", PdpSitePathKey);
