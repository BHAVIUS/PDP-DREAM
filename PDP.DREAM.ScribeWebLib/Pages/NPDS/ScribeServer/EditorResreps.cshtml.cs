...
public class ScribeServerEditorResreps : TkgsPageController
{
  private const string rzrClass = nameof(ScribeServerEditorResreps);
  public ScribeServerEditorResreps() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepScribeServerEditorResreps, PdpSitePathKey);
