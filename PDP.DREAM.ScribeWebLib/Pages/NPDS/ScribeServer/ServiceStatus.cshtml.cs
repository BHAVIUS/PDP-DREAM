...
public class ScribeServerServiceStatus : TkgsPageController
{
  private const string rzrClass = nameof(ScribeServerServiceStatus);
  public ScribeServerServiceStatus() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepScribeServerServiceStatus, PdpSitePathKey);
