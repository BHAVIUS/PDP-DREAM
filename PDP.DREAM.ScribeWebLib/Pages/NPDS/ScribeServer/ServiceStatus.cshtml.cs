...
public class ScribeServerServiceStatus : TkgsPageControllerBase
{
  private const string rzrCntrllr = nameof(ScribeServerServiceStatus);
  public ScribeServerServiceStatus(QebIdentityContext userCntxt,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSR = new PdpSiteRazorModel(DepScribeServerServiceStatus, PdpSitePathKey);
