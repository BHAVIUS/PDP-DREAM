...
public class ScribeServerServiceRestrictions : TkgsPageController
{
  private const string rzrClass = nameof(ScribeServerServiceRestrictions);
  public ScribeServerServiceRestrictions() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepScribeServerServiceRestrictions, PdpSitePathKey);
