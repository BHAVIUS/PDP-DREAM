...
public class ScribeServerServiceRestrictions : TkgsPageControllerBase
{
  private const string rzrCntrllr = nameof(ScribeServerServiceRestrictions);
  public ScribeServerServiceRestrictions(QebIdentityContext userCntxt,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSR = new PdpSiteRazorModel("/NPDS/ScribeServer/ServiceRestrictions", PdpSitePathKey);
