...
public class ScribeServerServiceDefaults : TkgsPageControllerBase
{
  private const string rzrCntrllr = nameof(ScribeServerServiceDefaults);
  public ScribeServerServiceDefaults(QebIdentityContext userCntxt, 
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSR = new PdpSiteRazorModel(DepScribeServerServiceDefaults, PdpSitePathKey);
