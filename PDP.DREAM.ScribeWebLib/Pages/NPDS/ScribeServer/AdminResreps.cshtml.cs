...
public class ScribeServerAdminResreps : TkgsPageControllerBase
{
  private const string rzrCntrllr = nameof(ScribeServerAdminResreps);
  public ScribeServerAdminResreps(QebIdentityContext userCntxt,
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSR = new PdpSiteRazorModel("/NPDS/ScribeServer/AdminResreps", PdpSitePathKey);
