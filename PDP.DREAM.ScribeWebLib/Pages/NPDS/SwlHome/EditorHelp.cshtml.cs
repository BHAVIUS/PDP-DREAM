...
{
  private const string rzrCntrllr = nameof(SwlHomeEditorHelp);
  public SwlHomeEditorHelp(QebIdentityContext userCntxt,
    ScribeDbsqlContext npdsCntxt) : base(userCntxt, npdsCntxt) { }

  // OnPageHandlerExecuting before OnGet
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    PSR = new PdpSiteRazorModel("/NPDS/SwlHome/EditorHelp", PdpSitePathKey);
