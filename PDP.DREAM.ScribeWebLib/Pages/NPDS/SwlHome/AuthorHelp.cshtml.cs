...
public class SwlHomeAuthorHelp : ScribeDataRazorPageControllerBase
{
  private const string rzrCntrllr = nameof(SwlHomeAuthorHelp);
  public SwlHomeAuthorHelp(QebIdentityContext userCntxt,
    ScribeDbsqlContext npdsCntxt) : base(userCntxt, npdsCntxt) { }

  // OnPageHandlerExecuting before OnGet
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    PSR = new PdpSiteRazorModel("/NPDS/SwlHome/AuthorHelp", PdpSitePathKey);
