...
public class SwlHomeAdminHelp : ScribeDataRazorPageControllerBase
{
  private const string rzrCntrllr = nameof(SwlHomeAdminHelp);
  public SwlHomeAdminHelp(QebIdentityContext userCntxt,
    ScribeDbsqlContext npdsCntxt) : base(userCntxt, npdsCntxt) { }

  // OnPageHandlerExecuting before OnGet
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    PSR = new PdpSiteRazorModel("/NPDS/SwlHome/AdminHelp", PdpSitePathKey);
