...
{
  public virtual JsonResult OnPostReadDescriptionExtns([DataSourceRequest] DataSourceRequest dsRequest,
   Guid recordGuid, bool isLimited = false)
  {
    var rzrHndlr = nameof(OnPostReadDescriptionExtns);
    ...
    try
    {
      ...
      { ModelState.AddModelError("DescriptionExtns", "RRRecordGuid invalid."); }
      else
      {
        dsResult = PSDC.ListEditableDescriptionExtns(recordGuid, isLimited)
  ...
  public virtual JsonResult OnPostWriteDescriptionExtn([DataSourceRequest] DataSourceRequest dsRequest,
    DescriptionExtnUxm fgr, Guid recordGuid, bool isLimited = false)
  {
    OpenScribeConnection(); // use PSDC
