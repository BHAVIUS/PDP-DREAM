...
public partial class ScribeTkgViewController
{
    ...
    string serviceTag, Guid rstrctAndGuid, Guid recordGuid, bool isLimited = false)
  {
    ...
    try
    {
      ...
      {
        dsResult = NPDSCW.ScribeDR.ListEditableRestrictionOrsByRGuid(recordGuid, isLimited)
    ...
    string serviceTag, Guid rstrctAndGuid, Guid recordGuid, bool isLimited)
  {
    ...
    var records = NPDSCW.ScribeDR.ListEditableRestrictionOrsByAGuid(rstrctAndGuid, isLimited);
