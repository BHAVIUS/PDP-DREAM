...
{
  private const string eidDescriptionExtnStatus = TkndoElemPrfx + "DescriptionExtnStatus";

  public JsonResult OnPostReadDescriptionExtns([DataSourceRequest] DataSourceRequest dsRequest,
    Guid recordGuid, bool isLimited = false)
  {
    ...
    {
      dsResult = NPDSCW.NexusDR.ListEditableDescriptionExtns(recordGuid, isLimited)
