...
{
  private const string eidProvenanceFactStatus = TkndoElemPrfx + "ProvenanceFactStatus";

  public JsonResult OnPostReadProvenanceFacts([DataSourceRequest] DataSourceRequest dsRequest,
    Guid recordGuid, bool isLimited = false)
  {
    var rzrHndlr = nameof(OnPostReadProvenanceFacts);
#if DEBUG
    ...
    { ModelState.AddModelError("ProvenanceFacts", "RRRecordGuid invalid."); }
    else
    {
      dsResult = NPDSCW.NexusDR.ListEditableProvenanceFacts(recordGuid, isLimited)
