...
{
  private const string eidDescriptionFactStatus = TkndoElemPrfx + "DescriptionFactStatus";

  public JsonResult OnPostReadDescriptionFacts([DataSourceRequest] DataSourceRequest dsRequest,
    Guid recordGuid, bool isLimited = false)
  {
    var rzrHndlr = nameof(OnPostReadDescriptionFacts);
#if DEBUG
    ...
    { ModelState.AddModelError("DescriptionFacts", "RRRecordGuid invalid."); }
    else
    {
      dsResult = NPDSCW.NexusDR.ListEditableDescriptionFacts(recordGuid, isLimited)
