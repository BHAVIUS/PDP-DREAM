...
public class QebiAnonModeResetUsername2 : QebiDataRazorPageControllerBase
{
  ...
  public IActionResult OnGet(string password)
  {
    ...
    var usr = NPDSCW.QebiDR.GetUserByPassWord(UXM.PassWord);
  ...
  public IActionResult OnPost()
  {
    ...
    {
      var uxm = Controllers.IQebiUser.ResetUsernameWithToken(UXM.PassWord, UXM.SecurityAnswer); // update database
      if (uxm.DbfieldReset)
      {
        uxm = Controllers.IQebiUser.NotifyUsernameWithToken(uxm, HttpContext); // send message
