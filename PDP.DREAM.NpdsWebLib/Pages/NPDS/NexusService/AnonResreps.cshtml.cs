...
public class NexusServiceAnonResreps : NexusTkgPageController
{
  private const string rzrClass = nameof(NexusServiceAnonResreps);
  public NexusServiceAnonResreps() : base() { }

  // NexusService AdminResreps
  public const string pageName = DepNexusServiceAnonResreps;
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    NPDSCW = new NpdsClientWrace(exeCntxt.HttpContext)
    {
      ...
      RecordAccess = NPDSCD.RecordAccessAnon, // resets *ClientRequired
