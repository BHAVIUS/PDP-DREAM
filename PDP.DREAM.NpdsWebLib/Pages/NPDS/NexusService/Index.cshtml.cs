...
public class NexusServiceIndex : NexusTkgPageController
{
  private const string rzrClass = nameof(NexusServiceIndex);
  public NexusServiceIndex() : base() { }

  // NexusService Index
  public const string pageName = DepNexusServiceIndex;
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    {
      ServiceType = NPDSCD.ServiceTypeDiristry, // resets ServicePath, SearchType, ServiceTag
