...
[RequireHttps, PdpAuthorizeRoles(NpdsAgentRS)]
public class NexusServiceAgentResreps : NexusTkgPageController
{
  private const string rzrClass = nameof(NexusServiceAgentResreps);
  public NexusServiceAgentResreps() : base() { }

  // NexusService AgentResreps
  public const string pageName = DepNexusServiceAgentResreps;
