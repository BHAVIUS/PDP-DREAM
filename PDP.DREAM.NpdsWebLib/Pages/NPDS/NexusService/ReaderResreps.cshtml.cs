...
[RequireHttps, PdpAuthorizeRoles(NpdsReaderRS, NpdsEditorRS, NpdsAdminRS)]
public class NexusServiceReaderResreps : NexusTkgPageController
{
  private const string rzrClass = nameof(NexusServiceReaderResreps);
  public NexusServiceReaderResreps() : base() { }

  // NexusService AdminResreps
  public const string pageName = DepNexusServiceReaderResreps;
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    NPDSCW = new NpdsClientWrace(exeCntxt.HttpContext)
    {
      ...
      RecordAccess = NPDSCD.RecordAccessReader, // resets *ClientRequired
	...
	// TODO: migrate to CheckNpdsReaderClient
