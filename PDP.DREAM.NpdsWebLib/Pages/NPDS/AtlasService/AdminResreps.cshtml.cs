...
public class AtlasServiceAdminResreps : AtlasTkgPageController
{
  private const string rzrClass = nameof(AtlasServiceAdminResreps);
  public AtlasServiceAdminResreps() { }

  // AtlasService AdminResreps
  public const string pageName = DepAtlasServiceAdminResreps;
  public const string pagePath = pageName;
  public const string bodyTitle = PdpSitePathKey;
  public const string bodyMenu = "_AtlasServiceSpanPageMenu";
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    {
      ServiceType = NPDSCD.ServiceTypeArchive, // resets ServicePath
      DatabaseAccess = NPDSCD.DatabaseAccessAuthReadWrite,
      RecordAccess = NPDSCD.RecordAccessAdmin, // resets *ClientRequired
      ResrepFormat = NPDSCD.ResrepFormatAtlas, // requires ServicePath
    };
  ...
  public IActionResult OnGet(string serviceType, string serviceTag, string entityType, string resrepFormat)
  {
    ...
    // TODO: SelectFilter constrained to Atlas service
