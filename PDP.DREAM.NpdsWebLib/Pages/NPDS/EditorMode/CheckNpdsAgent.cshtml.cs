...
public class NpdsEditorModeCheckNpdsAgent : AtlasTkgPageController
{
  private const string rzrClass = nameof(NpdsEditorModeCheckNpdsAgent);
  public NpdsEditorModeCheckNpdsAgent() : base() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepnEditorModeCheckNpdsAgent, "Check NPDS Editor", true);
