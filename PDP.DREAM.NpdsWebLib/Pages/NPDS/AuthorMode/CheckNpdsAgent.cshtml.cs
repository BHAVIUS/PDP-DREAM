...
public class NpdsAuthorModeCheckNpdsAgent : AtlasTkgPageController
{
  private const string rzrClass = nameof(NpdsAuthorModeCheckNpdsAgent);
  public NpdsAuthorModeCheckNpdsAgent() : base() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel(DepnAuthorModeCheckNpdsAgent, "Check NPDS Agent", true);
