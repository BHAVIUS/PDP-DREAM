...
public class ScribeServiceAtlasServers : ScribeTkgPageController
{
  private const string rzrClass = nameof(ScribeServiceAtlasServers);
  public ScribeServiceAtlasServers() : base() { }

  // ScribeService Atlas Servers
  public const string pageName = DepScribeServiceAtlasServers;
  ...
  public IActionResult OnGet(string serviceType, string serviceTag, string entityType, string resrepFormat)
  {
    ...
    if (string.IsNullOrEmpty(entityType)) { entityType = NPDSCD.EntityTypeNpdsServers.EName; }
