...
public class ScribeServiceAtlasResreps : ScribeTkgPageController
{
  private const string rzrClass = nameof(ScribeServiceAtlasResreps);
  public ScribeServiceAtlasResreps() : base() { }

  // ScribeService AtlasResreps
  public const string pageName = DepScribeServiceAtlasResreps;
  ...
  {
    if (string.IsNullOrEmpty(serviceType)) { serviceType = NPDSCD.SearchTypeEnmDflt.EName; }
