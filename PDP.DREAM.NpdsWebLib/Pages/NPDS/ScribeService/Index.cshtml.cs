...
[RequireHttps, PdpAuthorizeRoles(NpdsAgentRS, NpdsAuthorRS, NpdsReviewerRS, NpdsEditorRS, NpdsAdminRS)]
public class ScribeServiceIndex : ScribeTkgPageController
{
  private const string rzrClass = nameof(ScribeServiceIndex);
  public ScribeServiceIndex() : base() { }

  // ScribeService Index
  public const string pageName = DepScribeServiceIndex;
