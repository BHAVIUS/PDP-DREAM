...
public class ScribeServiceReviewerResreps : ScribeTkgPageController
{
  private const string rzrClass = nameof(ScribeServiceReviewerResreps);
  public ScribeServiceReviewerResreps() : base() { }

  // ScribeService ReviewerResreps
  public const string pageName = DepScribeServiceReviewerResreps;
