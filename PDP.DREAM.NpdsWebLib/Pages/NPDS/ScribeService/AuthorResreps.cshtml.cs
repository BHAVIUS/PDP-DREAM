...
public class ScribeServiceAuthorResreps : ScribeTkgPageController
{
  private const string rzrClass = nameof(ScribeServiceAuthorResreps);
  public ScribeServiceAuthorResreps() : base() { }

  // ScribeService AuthorResreps
  public const string pageName = DepScribeServiceAuthorResreps;
