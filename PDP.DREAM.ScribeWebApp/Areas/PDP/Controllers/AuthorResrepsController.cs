...
namespace PDP.DREAM.ScribeWebApp.Controllers
{
  ...
  public class AuthorResrepsController : AuthorScribeTkgrController
  {
    public AuthorResrepsController(ScribeDbsqlContext npdsCntxt, PdpAgentCmsContext userCntxt) : base(npdsCntxt, userCntxt) { }
