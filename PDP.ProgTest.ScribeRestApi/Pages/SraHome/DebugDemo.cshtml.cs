...
public class SraHomeDebugDemo : CoreDataRazorPageControllerBase
{
  private const string rzrClass = nameof(SraHomeDebugDemo);
  public SraHomeDebugDemo(ILoggerFactory lgrFtry, 
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel("/SraHome/DebugDemo");
