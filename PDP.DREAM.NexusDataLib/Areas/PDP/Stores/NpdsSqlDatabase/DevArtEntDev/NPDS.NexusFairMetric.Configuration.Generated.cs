...
namespace PDP.DREAM.NpdsDataLib.Stores.NpdsSqlDatabase
{
    ...
    public partial class NexusFairMetricConfiguration : IEntityTypeConfiguration<NexusFairMetric>
    {
        /// <summary>
        /// There are no comments for Configure(EntityTypeBuilder<NexusFairMetric> builder) method in the schema.
        /// </summary>
        public void Configure(EntityTypeBuilder<NexusFairMetric> builder)
        {
            builder.ToTable(@"NexusFairMetric", @"dbo");
            ...
            builder.Property(x => x.MInvalidOldClaim).HasColumnName(@"M_InvalidOldClaim").HasColumnType(@"smallint").IsRequired().ValueGeneratedNever().HasPrecision(5, 0);
            builder.Property(x => x.QValidOldClaim).HasColumnName(@"Q_ValidOldClaim").HasColumnType(@"smallint").IsRequired().ValueGeneratedNever().HasPrecision(5, 0);
            builder.Property(x => x.PInvalidNewClaim).HasColumnName(@"P_InvalidNewClaim").HasColumnType(@"smallint").IsRequired().ValueGeneratedNever().HasPrecision(5, 0);
            builder.Property(x => x.NValidNewClaim).HasColumnName(@"N_ValidNewClaim").HasColumnType(@"smallint").IsRequired().ValueGeneratedNever().HasPrecision(5, 0);
            builder.Property(x => x.FAIR1).HasColumnName(@"FAIR1").HasColumnType(@"real").IsRequired().ValueGeneratedNever().HasPrecision(24);
            builder.Property(x => x.FAIR2).HasColumnName(@"FAIR2").HasColumnType(@"real").IsRequired().ValueGeneratedNever().HasPrecision(24);
            builder.Property(x => x.FAIR3).HasColumnName(@"FAIR3").HasColumnType(@"real").IsRequired().ValueGeneratedNever().HasPrecision(24);
            ...
            builder.Property(x => x.FAIR4).HasColumnName(@"FAIR4").HasColumnType(@"real").IsRequired().ValueGeneratedNever().HasPrecision(24);
            ...
            builder.HasOne(x => x.NexusResrepRoot).WithMany(op => op.NexusFairMetrics).HasForeignKey(@"RecordGuidRef").IsRequired(true);
            builder.HasOne(x => x.NexusResrepStem).WithMany(op => op.NexusFairMetrics).HasForeignKey(@"RecordGuidRef").IsRequired(true);
            builder.HasOne(x => x.NexusResrepLeaf).WithMany(op => op.NexusFairMetrics).HasForeignKey(@"RecordGuidRef").IsRequired(true);
