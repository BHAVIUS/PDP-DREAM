...
namespace PDP.DREAM.NpdsDataLib.Stores.NpdsSqlDatabase
{
    ...
    public partial class NexusServiceNpdsDefaultConfiguration : IEntityTypeConfiguration<NexusServiceNpdsDefault>
    {
        /// <summary>
        /// There are no comments for Configure(EntityTypeBuilder<NexusServiceNpdsDefault> builder) method in the schema.
        /// </summary>
        public void Configure(EntityTypeBuilder<NexusServiceNpdsDefault> builder)
        {
            builder.ToTable(@"NexusServiceNpdsDefault", @"dbo");
            ...
            builder.Property(x => x.DiristryName).HasColumnName(@"DiristryName").HasColumnType(@"nvarchar(128)").ValueGeneratedNever().HasMaxLength(128);
            ...
            builder.Property(x => x.RegistryName).HasColumnName(@"RegistryName").HasColumnType(@"nvarchar(128)").ValueGeneratedNever().HasMaxLength(128);
            ...
            builder.Property(x => x.DirectoryName).HasColumnName(@"DirectoryName").HasColumnType(@"nvarchar(128)").ValueGeneratedNever().HasMaxLength(128);
            ...
            builder.Property(x => x.RegistrarName).HasColumnName(@"RegistrarName").HasColumnType(@"nvarchar(128)").ValueGeneratedNever().HasMaxLength(128);
            ...
            builder.HasOne(x => x.NexusResrepStem).WithMany(op => op.NexusServiceNpdsDefaults).HasForeignKey(@"RecordGuidRef").IsRequired(true);
