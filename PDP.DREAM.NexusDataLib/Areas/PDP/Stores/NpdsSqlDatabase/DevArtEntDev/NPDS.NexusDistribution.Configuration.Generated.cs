...
namespace PDP.DREAM.NpdsDataLib.Stores.NpdsSqlDatabase
{
    ...
    public partial class NexusDistributionConfiguration : IEntityTypeConfiguration<NexusDistribution>
    {
        /// <summary>
        /// There are no comments for Configure(EntityTypeBuilder<NexusDistribution> builder) method in the schema.
        /// </summary>
        public void Configure(EntityTypeBuilder<NexusDistribution> builder)
        {
            builder.ToTable(@"NexusDistribution", @"dbo");
            ...
            builder.HasOne(x => x.NexusResrepRoot).WithMany(op => op.NexusDistributions).HasForeignKey(@"RecordGuidRef").IsRequired(true);
            builder.HasOne(x => x.NexusResrepStem).WithMany(op => op.NexusDistributions).HasForeignKey(@"RecordGuidRef").IsRequired(true);
            builder.HasOne(x => x.NexusResrepLeaf).WithMany(op => op.NexusDistributions).HasForeignKey(@"RecordGuidRef").IsRequired(true);
