...
namespace PDP.DREAM.NpdsDataLib.Stores.NpdsSqlDatabase
{
    ...
    public partial class NexusResrepSnapshotConfiguration : IEntityTypeConfiguration<NexusResrepSnapshot>
    {
        /// <summary>
        /// There are no comments for Configure(EntityTypeBuilder<NexusResrepSnapshot> builder) method in the schema.
        /// </summary>
        public void Configure(EntityTypeBuilder<NexusResrepSnapshot> builder)
        {
            builder.ToTable(@"NexusResrepSnapshot", @"dbo");
            ...
            builder.HasOne(x => x.NexusResrepStem).WithMany(op => op.NexusResrepSnapshots).HasForeignKey(@"RecordGuidRef").IsRequired(true);
            builder.HasOne(x => x.NexusResrepLeaf).WithMany(op => op.NexusResrepSnapshots).HasForeignKey(@"RecordGuidRef").IsRequired(true);
