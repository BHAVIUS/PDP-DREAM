...
namespace PDP.DREAM.NexusDataLib.Stores
{
    ...
    public partial class NexusEntityAliasLabelConfiguration : IEntityTypeConfiguration<NexusEntityAliasLabel>
    {
        ...
        public void Configure(EntityTypeBuilder<NexusEntityAliasLabel> builder)
        {
            ...
            builder.Property(x => x.EntityAliasLabel).HasColumnName(@"EntityAliasLabel").HasColumnType(@"nvarchar(384)").IsRequired().ValueGeneratedNever().HasMaxLength(384);
            builder.Property(x => x.EntityAliasTag).HasColumnName(@"EntityAliasTag").HasColumnType(@"nvarchar(128)").IsRequired().ValueGeneratedNever().HasMaxLength(128);
