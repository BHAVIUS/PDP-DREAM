...
namespace PDP.DREAM.NexusDataLib.Stores
{
    ...
    public partial class NexusSupportingTagConfiguration : IEntityTypeConfiguration<NexusSupportingTag>
    {
        /// <summary>
        /// There are no comments for Configure(EntityTypeBuilder<NexusSupportingTag> builder) method in the schema.
        /// </summary>
        public void Configure(EntityTypeBuilder<NexusSupportingTag> builder)
        {
            builder.ToTable(@"NexusSupportingTag", @"dbo");
            ...
            builder.HasOne(x => x.NexusResrepRoot).WithMany(op => op.NexusSupportingTags).HasForeignKey(@"RecordGuidRef").IsRequired(true);
            builder.HasOne(x => x.NexusResrepStem).WithMany(op => op.NexusSupportingTags).HasForeignKey(@"RecordGuidRef").IsRequired(true);
            builder.HasOne(x => x.NexusResrepLeaf).WithMany(op => op.NexusSupportingTags).HasForeignKey(@"RecordGuidRef").IsRequired(true);
