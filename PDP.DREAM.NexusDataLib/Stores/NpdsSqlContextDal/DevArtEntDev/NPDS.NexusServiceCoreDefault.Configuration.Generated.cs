...
namespace PDP.DREAM.NexusDataLib.Stores
{
    ...
    public partial class NexusServiceCoreDefaultConfiguration : IEntityTypeConfiguration<NexusServiceCoreDefault>
    {
        /// <summary>
        /// There are no comments for Configure(EntityTypeBuilder<NexusServiceCoreDefault> builder) method in the schema.
        /// </summary>
        public void Configure(EntityTypeBuilder<NexusServiceCoreDefault> builder)
        {
            builder.ToTable(@"NexusServiceCoreDefault", @"dbo");
            ...
            builder.HasOne(x => x.NexusResrepStem).WithMany(op => op.NexusServiceCoreDefaults).HasForeignKey(@"RecordGuidRef").IsRequired(true);
            builder.HasOne(x => x.NexusResrepLeaf).WithMany(op => op.NexusServiceCoreDefaults).HasForeignKey(@"RecordGuidRef").IsRequired(true);
