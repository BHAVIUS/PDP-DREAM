...
namespace PDP.DREAM.NexusDataLib.Stores
{
    ...
    public partial class NexusPortalSnapshotConfiguration : IEntityTypeConfiguration<NexusPortalSnapshot>
    {
        /// <summary>
        /// There are no comments for Configure(EntityTypeBuilder<NexusPortalSnapshot> builder) method in the schema.
        /// </summary>
        public void Configure(EntityTypeBuilder<NexusPortalSnapshot> builder)
        {
            builder.ToTable(@"NexusPortalSnapshot", @"dbo");
