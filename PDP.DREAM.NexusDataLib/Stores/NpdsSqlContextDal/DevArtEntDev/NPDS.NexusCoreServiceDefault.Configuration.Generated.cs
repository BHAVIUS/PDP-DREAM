...
namespace PDP.DREAM.NexusDataLib.Stores
{
    ...
    public partial class NexusCoreServiceDefaultConfiguration : IEntityTypeConfiguration<NexusCoreServiceDefault>
    {
        /// <summary>
        /// There are no comments for Configure(EntityTypeBuilder<NexusCoreServiceDefault> builder) method in the schema.
        /// </summary>
        public void Configure(EntityTypeBuilder<NexusCoreServiceDefault> builder)
        {
            builder.ToTable(@"NexusCoreServiceDefault", @"dbo");
            ...
            builder.Property(x => x.DiristryInfosetGuidRef).HasColumnName(@"DiristryInfosetGuidRef").HasColumnType(@"uniqueidentifier").IsRequired().ValueGeneratedNever();
            ...
            builder.Property(x => x.RegistryInfosetGuidRef).HasColumnName(@"RegistryInfosetGuidRef").HasColumnType(@"uniqueidentifier").IsRequired().ValueGeneratedNever();
            ...
            builder.Property(x => x.DirectoryInfosetGuidRef).HasColumnName(@"DirectoryInfosetGuidRef").HasColumnType(@"uniqueidentifier").IsRequired().ValueGeneratedNever();
            ...
            builder.Property(x => x.RegistrarInfosetGuidRef).HasColumnName(@"RegistrarInfosetGuidRef").HasColumnType(@"uniqueidentifier").IsRequired().ValueGeneratedNever();
            ...
            builder.HasOne(x => x.NexusResrepRoot).WithMany(op => op.NexusCoreServiceDefaults).HasForeignKey(@"RecordGuidRef").IsRequired(true);
            builder.HasOne(x => x.NexusResrepLeaf).WithMany(op => op.NexusCoreServiceDefaults).HasForeignKey(@"RecordGuidRef").IsRequired(true);
            builder.HasOne(x => x.NexusResrepStem).WithMany(op => op.NexusCoreServiceDefaults).HasForeignKey(@"RecordGuidRef").IsRequired(true);
