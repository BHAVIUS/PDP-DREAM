...
namespace PDP.DREAM.NexusDataLib.Stores
{
    ...
    public partial class NexusNexusSnapshotConfiguration : IEntityTypeConfiguration<NexusNexusSnapshot>
    {
        /// <summary>
        /// There are no comments for Configure(EntityTypeBuilder<NexusNexusSnapshot> builder) method in the schema.
        /// </summary>
        public void Configure(EntityTypeBuilder<NexusNexusSnapshot> builder)
        {
            builder.ToTable(@"NexusNexusSnapshot", @"dbo");
            ...
            builder.HasOne(x => x.NexusResrepStem).WithMany(op => op.NexusNexusSnapshots).HasForeignKey(@"RecordGuidRef").IsRequired(true);
            builder.HasOne(x => x.NexusResrepLeaf).WithMany(op => op.NexusNexusSnapshots).HasForeignKey(@"RecordGuidRef").IsRequired(true);
