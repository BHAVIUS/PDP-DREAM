...
namespace PDP.DREAM.NexusDataLib.Stores
{
    ...
    public partial class NexusDoorsSnapshotConfiguration : IEntityTypeConfiguration<NexusDoorsSnapshot>
    {
        /// <summary>
        /// There are no comments for Configure(EntityTypeBuilder<NexusDoorsSnapshot> builder) method in the schema.
        /// </summary>
        public void Configure(EntityTypeBuilder<NexusDoorsSnapshot> builder)
        {
            builder.ToTable(@"NexusDoorsSnapshot", @"dbo");
