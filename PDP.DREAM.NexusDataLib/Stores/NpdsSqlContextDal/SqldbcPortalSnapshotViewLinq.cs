// SqldbcUilPortalSnapshotViewLinq.cs 
...
public static partial class NpdsLinqSqlOperators
{
  ...
  //  NexusResrepSnapshot, PortalResrepSnapshot, DoorsResrepSnapshot
  public static IQueryable<PortalSnapshotViewModel> ToViewable(this IQueryable<NexusPortalSnapshot> query)
  {
    throw new NotImplementedException();

    //IQueryable<PortalSnapshotViewModel> rows =
    //  from r in query
