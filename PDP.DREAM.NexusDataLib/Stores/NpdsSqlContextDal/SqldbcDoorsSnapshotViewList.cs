// SqldbcUilDoorsSnapshotViewList.cs 
...
{
  public IEnumerable<DoorsSnapshotViewModel> ListViewableDoorsSnapshots(Guid guidKey, bool isLimited = false)
  {
    IEnumerable<DoorsSnapshotViewModel> result;
    try
    {
    ...
    {
      result = Enumerable.Empty<DoorsSnapshotViewModel>();
    }
    return result;
  }
