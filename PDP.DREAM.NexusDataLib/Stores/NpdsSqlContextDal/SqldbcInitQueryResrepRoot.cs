...
{
  // TODO: consider converting queries for *ResrepRoot/Stem/Leaf to generic method with generic types 
  //    for item TResrep* and list TResrep*s, eg, item INexusResrepRoot and list NexusResrepRoots
  //    but may not be possible due to current implementation with dependency on Devart code generation 
  //
  // TODO: convert filter parameter to PRC properties
  public IQueryable<INexusResrepRoot> InitQueryStorableNexusRoot(bool filterAuthoritativeOnly = false,
