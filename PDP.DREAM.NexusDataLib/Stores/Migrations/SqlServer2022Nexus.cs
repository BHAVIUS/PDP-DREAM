...
public static class SqlServer2022Nexus
{
  public static bool CheckDatabase(NexusDbsqlContext? dbCntxt)
  {
  ...
  public static bool CreateDatabase(string dbCnstr, IFileProvider fileProv)
  {
    ...
    NexusDbsqlContext? dbCntxt = null;

    try
    {
      dbCntxt = new NexusDbsqlContext();
    }
