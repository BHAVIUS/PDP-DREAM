...
namespace PDP.DREAM.NexusDataLib.Migrations;

public static class SqlServer2019Nexus
{
  public static bool CheckDatabase(SqlConnection dbConn)
  {
    ...
    try
    {
      var dbCntxt = new NexusDbsqlContext(dbConn);
  ...
  public static bool CreateDatabase(string dbCnstr, IFileProvider fileProv)
  {
    ...
    var dbCntxt = new NexusDbsqlContext(dbCnstr);

    try
    {
      dbCntxt = new NexusDbsqlContext(NPDSSD.NpdsDiristryDbconstr);
    }
    ...
    if (!dbCntxt.Database.CanConnect())
    {
      ...
      var fileInfo = fileProv.GetFileInfo(@"\Migrations\CreatePdpNexus10.sql");
