...
public class CraHomeIndex : TkgcPageController
{
  private const string rzrClass = nameof(CraHomeIndex);
  public CraHomeIndex() : base() { }
  ...
  public override void OnPageHandlerExecuting(PageHandlerExecutingContext exeCntxt)
  {
    ...
    PSRM = new PdpSiteRazorModel("/CraHome/Index", PdpSitePathKey);
    PSRM.InitRazorPageMenus("_CraHomeSpanPageMenu");
    ResetCoreRepository();
#if DEBUG
