...
namespace PDP.DREAM.NpdsDataLib.Stores.NpdsSqlDatabase
{
    ...
    public partial class CoreServiceDefault {
        ...
        public virtual Guid DefDiristryGuid { get; set; }

        public virtual Guid DefRegistryGuid { get; set; }

        public virtual Guid DefDirectoryGuid { get; set; }

        public virtual Guid DefRegistrarGuid { get; set; }
