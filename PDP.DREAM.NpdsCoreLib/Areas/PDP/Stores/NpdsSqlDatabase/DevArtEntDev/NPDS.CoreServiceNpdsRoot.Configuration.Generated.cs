...
namespace PDP.DREAM.NpdsDataLib.Stores.NpdsSqlDatabase
{
    ...
    public partial class CoreServiceNpdsRootConfiguration : IEntityTypeConfiguration<CoreServiceNpdsRoot>
    {
        /// <summary>
        /// There are no comments for Configure(EntityTypeBuilder<CoreServiceNpdsRoot> builder) method in the schema.
        /// </summary>
        public void Configure(EntityTypeBuilder<CoreServiceNpdsRoot> builder)
        {
            builder.ToTable(@"CoreServiceNpdsRoot", @"dbo");
