...
namespace PDP.DREAM.NpdsCoreLib.Models
{
  ...
  // options for NPDS request
  // *Deflt is *Default on property names
  // *Reqst is *Request on property names
  public partial class PdpRestContext
  {
    // TODO: recode these properties
    public HttpRequest? PdpRequest
    {
      set
      {
        httpReqst = value;
        if (httpReqst != null)
        {
          PdpReqstBaseUrl = $"{httpReqst.Scheme}://{httpReqst.Host}{httpReqst.PathBase}";
          PdpReqstDisplayUrl = httpReqst.GetDisplayUrl();
          PdpReqstEncodedUrl = httpReqst.GetEncodedUrl();
          PdpReqstHost = httpReqst.Host;
          PdpReqstPath = httpReqst.Path;
          PdpReqstPathBase = httpReqst.PathBase;
          PdpReqstQuery = httpReqst.Query;
          PdpReqstQueryString = httpReqst.QueryString;
          PdpReqstScheme = httpReqst.Scheme;
        }
      }
      get { return httpReqst; }
    }
    private HttpRequest? httpReqst;

    public string? PdpReqstBaseUrl { get; set; }
    public string? PdpReqstDisplayUrl { get; set; }
    public string? PdpReqstEncodedUrl { get; set; }
    public HostString? PdpReqstHost { get; set; }
    public string? PdpReqstPath { get; set; }
    public string? PdpReqstPathBase { get; set; }
    public IQueryCollection? PdpReqstQuery { get; set; }
    public QueryString? PdpReqstQueryString { get; set; }
    public string? PdpReqstScheme { get; set; }
    // TODO: relocate in a core folder such as /nsvo/ or /npds/
    public string? PdpReqstXmlSchemaUrl { get { return PdpReqstBaseUrl + "/pub/xsd/"; } }
