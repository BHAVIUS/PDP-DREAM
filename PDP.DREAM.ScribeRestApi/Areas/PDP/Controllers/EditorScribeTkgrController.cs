...
namespace PDP.DREAM.ScribeRestApi.Controllers
{
  ...
  public class EditorScribeTkgrController : TkgrControllerBase
  {
    public EditorScribeTkgrController(ScribeDbsqlContext npdsCntxt, PdpAgentCmsContext userCntxt) : base(npdsCntxt, userCntxt) { }
