...
### PORTAL-DOORS Project - Repository for C# Software

  This PDP-DREAM software requires a user interface widget package available from https://www.telerik.com/ called the Telerik UI for ASP.NET Core Components. 
