...
namespace PDP.DREAM.SiaaDataLib.Stores.PdpIdentity
{
    ...
    public partial class QebIdentityContext : DbContext
    {

        public QebIdentityContext() :
            base()
        {
            OnCreated();
        }

        public QebIdentityContext(DbContextOptions<QebIdentityContext> options) :
            base(options)
        {
            OnCreated();
        }
        ...
        public int? QebIdentityAppUserEmailUpdate (Guid? AppGuidRef, Guid? UserGuidKey, string EmailAddress, string EmailAlternate, string SecurityToken, DateTime? DateTokenExpired, DateTime? DateEmailConfirmed, DateTime? DateLastEdit, bool? EmailConfirmed)
        {
            ...
            try
            {
                using (DbCommand cmd = connection.CreateCommand())
                {
                    if (this.Database.GetCommandTimeout().HasValue)
                        cmd.CommandTimeout = this.Database.GetCommandTimeout().Value;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.CommandText = @"dbo.QebIdentityAppUserEmailUpdate";
        ...
        public async Task<int?> QebIdentityAppUserEmailUpdateAsync (Guid? AppGuidRef, Guid? UserGuidKey, string EmailAddress, string EmailAlternate, string SecurityToken, DateTime? DateTokenExpired, DateTime? DateEmailConfirmed, DateTime? DateLastEdit, bool? EmailConfirmed)
        {
        ...
        public int? QebIdentityAppUserPasswordUpdate (Guid? AppGuidRef, Guid? UserGuidKey, string PasswordHash, string SecurityToken, DateTime? DateTokenExpired, DateTime? DatePasswordChanged, DateTime? DateLastEdit)
        {
            ...
            try
            {
                using (DbCommand cmd = connection.CreateCommand())
                {
                    if (this.Database.GetCommandTimeout().HasValue)
                        cmd.CommandTimeout = this.Database.GetCommandTimeout().Value;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.CommandText = @"dbo.QebIdentityAppUserPasswordUpdate";
        ...
        public async Task<int?> QebIdentityAppUserPasswordUpdateAsync (Guid? AppGuidRef, Guid? UserGuidKey, string PasswordHash, string SecurityToken, DateTime? DateTokenExpired, DateTime? DatePasswordChanged, DateTime? DateLastEdit)
        {
        ...
        public int? QebIdentityAppUserProfileUpdate (Guid? AppGuidRef, Guid? UserGuidKey, string UserNameDisplayed, string FirstName, string LastName, string Organization, string PhoneNumber, string SecurityAnswer, string SecurityQuestion, string WebsiteAddress, DateTime? DateProfileChanged, DateTime? DateLastEdit)
        {
            ...
            try
            {
                using (DbCommand cmd = connection.CreateCommand())
                {
                    if (this.Database.GetCommandTimeout().HasValue)
                        cmd.CommandTimeout = this.Database.GetCommandTimeout().Value;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.CommandText = @"dbo.QebIdentityAppUserProfileUpdate";
